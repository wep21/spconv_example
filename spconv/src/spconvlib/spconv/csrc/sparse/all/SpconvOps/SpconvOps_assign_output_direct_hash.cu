...
void SpconvOps::assign_output_direct_hash(tv::Tensor out_indices_offset, tv::Tensor out_indices, int batch_size, std::vector<int> output_dims, std::vector<int> input_dims, std::vector<int> ksize, std::vector<int> stride, std::vector<int> padding, std::vector<int> dilation, std::uintptr_t stream_int)   {
  ...
  if (ndim == 1){
      ...
      return SpconvIndices1D::assign_output_direct_hash(
  ...
  if (ndim == 2){
      ...
      return SpconvIndices2D::assign_output_direct_hash(
          out_indices_offset, out_indices, batch_size, output_dims_, input_dims_, 
          ksize_, stride_, padding_, dilation_, stream_int);
  }
  if (ndim == 3){
      ...
      return SpconvIndices3D::assign_output_direct_hash(
          out_indices_offset, out_indices, batch_size, output_dims_, input_dims_, 
          ksize_, stride_, padding_, dilation_, stream_int);
  }
  if (ndim == 4){
      ...
      return SpconvIndices4D::assign_output_direct_hash(
          out_indices_offset, out_indices, batch_size, output_dims_, input_dims_, 
          ksize_, stride_, padding_, dilation_, stream_int);
  }
