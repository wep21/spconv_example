...
int SparseConvIndicesCPU::generate_subm_conv_inds(tv::Tensor indices, tv::Tensor indice_pairs, tv::Tensor out_inds, tv::Tensor indice_num_per_loc, int batch_size, tv::array<int, 1> input_dims, tv::array<int, 1> ksize, tv::array<int, 1> dilation)   {
  
  tv::array<int, 1> stride, padding;
  for (int i = 0; i < 1; ++i){
