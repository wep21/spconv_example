...
void SparseConvIndicesKernel::assign_output_direct_hash(tv::Tensor out_indices_offset, tv::Tensor out_inds, int batch_size, tv::array<int, 2> output_dims, tv::array<int, 2> input_dims, tv::array<int, 2> ksize, tv::array<int, 2> stride, tv::array<int, 2> padding, tv::array<int, 2> dilation, std::uintptr_t stream_int)   {
