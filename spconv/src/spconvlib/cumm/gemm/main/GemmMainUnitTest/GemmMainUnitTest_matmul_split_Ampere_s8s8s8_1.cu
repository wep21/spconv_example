...
#include <spconvlib/cumm/gemm/main/gpAmpere_s8s8s8s32s32tnt_m128n128k64m64n64k64A1T8816_300_S1/GemmParams.h>
#include <spconvlib/cumm/gemm/main/Ampere_s8s8s8s32s32tnt_m128n128k64m64n64k64A1T8816_300_S1/GemmKernel.h>
#include <spconvlib/cumm/gemm/main/gpAmpere_s8s8s8s32s32tnt_m128n64k64m64n32k64A1T8816_300_S1/GemmParams.h>
#include <spconvlib/cumm/gemm/main/Ampere_s8s8s8s32s32tnt_m128n64k64m64n32k64A1T8816_300_S1/GemmKernel.h>
namespace spconvlib {
namespace cumm {
namespace gemm {
namespace main {
...
using GemmParamsAmpere_s8s8s8s32s32tnt_m128n128k64m64n64k64A1T8816_300_S1 = spconvlib::cumm::gemm::main::gpAmpere_s8s8s8s32s32tnt_m128n128k64m64n64k64A1T8816_300_S1::GemmParams;
using GemmAmpere_s8s8s8s32s32tnt_m128n128k64m64n64k64A1T8816_300_S1 = spconvlib::cumm::gemm::main::Ampere_s8s8s8s32s32tnt_m128n128k64m64n64k64A1T8816_300_S1::GemmKernel;
using GemmParamsAmpere_s8s8s8s32s32tnt_m128n64k64m64n32k64A1T8816_300_S1 = spconvlib::cumm::gemm::main::gpAmpere_s8s8s8s32s32tnt_m128n64k64m64n32k64A1T8816_300_S1::GemmParams;
using GemmAmpere_s8s8s8s32s32tnt_m128n64k64m64n32k64A1T8816_300_S1 = spconvlib::cumm::gemm::main::Ampere_s8s8s8s32s32tnt_m128n64k64m64n32k64A1T8816_300_S1::GemmKernel;
void GemmMainUnitTest::matmul_split_Ampere_s8s8s8_1(tv::gemm::GemmParams params)   {
  ...
  if (algo_desp.trans_a() == false && algo_desp.trans_b() == true && algo_desp.trans_c() == false){
    if (algo_desp.tile_shape == std::array<int, 3>{128, 128, 64}){
      if (algo_desp.warp_tile_shape == std::array<int, 3>{64, 64, 64}){
        if (algo_desp.num_stage == 3 && algo_desp.dacc == 1 && algo_desp.dcomp == 1){
          if ((params.split_k_slices == 1)){
            if (algo_desp.access_per_vector == 1){
              if (algo_desp.tensorop == std::array<int, 3>{8, 8, 16}){
                ...
                GemmParamsAmpere_s8s8s8s32s32tnt_m128n128k64m64n64k64A1T8816_300_S1 kernel_params(
                ...
                cudaError_t result;
                if (49152 >= (48 << 10)) {
                    result = cudaFuncSetAttribute(Ampere_s8s8s8s32s32tnt_m128n128k64m64n64k64A1T8816_300_S1::gemm_kernel,
                                                    cudaFuncAttributeMaxDynamicSharedMemorySize,
                                                    49152);
                    TV_ASSERT_RT_ERR(result == cudaSuccess, "error");
                    result = cudaFuncSetAttribute(
                        Ampere_s8s8s8s32s32tnt_m128n128k64m64n64k64A1T8816_300_S1::gemm_kernel,
                        cudaFuncAttributePreferredSharedMemoryCarveout, 100);
                    TV_ASSERT_RT_ERR(result == cudaSuccess, "error");
                }
                {
                    tv::CUDAKernelTimerGuard timerguard("Ampere_s8s8s8s32s32tnt_m128n128k64m64n64k64A1T8816_300_S1", evtimer, reinterpret_cast<cudaStream_t>(params.stream));
                    launcher(Ampere_s8s8s8s32s32tnt_m128n128k64m64n64k64A1T8816_300_S1::gemm_kernel, kernel_params);
                }
                TV_CHECK_CUDA_ERR_V2("Ampere_s8s8s8s32s32tnt_m128n128k64m64n64k64A1T8816_300_S1", "error with params", a.shape(), b.shape(), c.shape());
                return;
              }
            }
          }
    ...
    if (algo_desp.tile_shape == std::array<int, 3>{128, 64, 64}){
      if (algo_desp.warp_tile_shape == std::array<int, 3>{64, 32, 64}){
        if (algo_desp.num_stage == 3 && algo_desp.dacc == 1 && algo_desp.dcomp == 1){
          if ((params.split_k_slices == 1)){
            if (algo_desp.access_per_vector == 1){
              if (algo_desp.tensorop == std::array<int, 3>{8, 8, 16}){
                ...
                TV_ASSERT_RT_ERR(!c_inds.empty(), "c must not empty");
                // tv::ssprint(d.ndim() == 1 ? 0 : d_ten.stride(0), (d.ndim() == 1 ? nullptr : c_inds.data_ptr<const int>()) == nullptr, "WTF");
                GemmParamsAmpere_s8s8s8s32s32tnt_m128n64k64m64n32k64A1T8816_300_S1 kernel_params(
                    m, n, k, a_ten.data_ptr<const int8_t>(), b_ten.data_ptr<const int8_t>(),
                    c_ten.data_ptr<int8_t>(), d_ten.data_ptr<int8_t>(), 
                    a_ten.stride(0), b_ten.stride(0), c_ten.stride(0), d.ndim() == 1 ? 0 : d_ten.stride(0), 
                    a_ptr, c_inds.data_ptr<const int>(), d.ndim() == 1 ? nullptr : c_inds.data_ptr<const int>(), 
                ...
                cudaError_t result;
                if (36864 >= (48 << 10)) {
                    result = cudaFuncSetAttribute(Ampere_s8s8s8s32s32tnt_m128n64k64m64n32k64A1T8816_300_S1::gemm_kernel,
                                                    cudaFuncAttributeMaxDynamicSharedMemorySize,
                                                    36864);
                    TV_ASSERT_RT_ERR(result == cudaSuccess, "error");
                    result = cudaFuncSetAttribute(
                        Ampere_s8s8s8s32s32tnt_m128n64k64m64n32k64A1T8816_300_S1::gemm_kernel,
                        cudaFuncAttributePreferredSharedMemoryCarveout, 100);
                    TV_ASSERT_RT_ERR(result == cudaSuccess, "error");
                }
                {
                    tv::CUDAKernelTimerGuard timerguard("Ampere_s8s8s8s32s32tnt_m128n64k64m64n32k64A1T8816_300_S1", evtimer, reinterpret_cast<cudaStream_t>(params.stream));
                    launcher(Ampere_s8s8s8s32s32tnt_m128n64k64m64n32k64A1T8816_300_S1::gemm_kernel, kernel_params);
                }
                TV_CHECK_CUDA_ERR_V2("Ampere_s8s8s8s32s32tnt_m128n64k64m64n32k64A1T8816_300_S1", "error with params", a.shape(), b.shape(), c.shape());
                return;
              }
            }
          }
