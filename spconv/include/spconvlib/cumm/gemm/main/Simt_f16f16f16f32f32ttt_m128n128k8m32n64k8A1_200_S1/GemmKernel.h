...
#include <spconvlib/cumm/gemm/main/Simt_f16f16f16f32f32ttt_m128n128k8m32n64k8A1_200_S1/gemmutils/GemmUtils.h>
...
#include <spconvlib/cumm/gemm/main/Simt_f16f16f16f32f32ttt_m128n128k8m32n64k8A1_200_S1/mma/Mma.h>
#include <spconvlib/cumm/gemm/main/Simt_f16f16f16f32f32ttt_m128n128k8m32n64k8A1_200_S1/output/Output.h>
namespace spconvlib {
namespace cumm {
namespace gemm {
namespace main {
...
using GemmUtils = spconvlib::cumm::gemm::main::Simt_f16f16f16f32f32ttt_m128n128k8m32n64k8A1_200_S1::gemmutils::GemmUtils;
...
using BlockMmaStorage = spconvlib::cumm::gemm::main::Simt_f16f16f16f32f32ttt_m128n128k8m32n64k8A1_200_S1::gemm_smem_storage::BlockMmaStorage;
using OutputSmemStorage = spconvlib::cumm::gemm::main::Simt_f16f16f16f32f32ttt_m128n128k8m32n64k8A1_200_S1::out_smem_storage::OutputSmemStorage;
using GemmParams = spconvlib::cumm::gemm::main::gpSimt_f16f16f16f32f32ttt_m128n128k8m32n64k8A1_200_S1::GemmParams;
...
using Mma = spconvlib::cumm::gemm::main::Simt_f16f16f16f32f32ttt_m128n128k8m32n64k8A1_200_S1::mma::Mma;
using Output = spconvlib::cumm::gemm::main::Simt_f16f16f16f32f32ttt_m128n128k8m32n64k8A1_200_S1::output::Output;
/**
 * @param params 
 */
