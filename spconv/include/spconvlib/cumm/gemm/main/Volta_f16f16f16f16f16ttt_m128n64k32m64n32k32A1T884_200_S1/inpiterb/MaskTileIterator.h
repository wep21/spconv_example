...
#include <spconvlib/cumm/gemm/main/Volta_f16f16f16f16f16ttt_m128n64k32m64n32k32A1T884_200_S1/inpiterb/maskiter/PitchLinearWarpRaked.h>
...
#include <spconvlib/cumm/gemm/main/Volta_f16f16f16f16f16ttt_m128n64k32m64n32k32A1T884_200_S1/inpiterb/maskiter/GlobalLoad.h>
namespace spconvlib {
namespace cumm {
namespace gemm {
namespace main {
...
using ThreadMap = spconvlib::cumm::gemm::main::Volta_f16f16f16f16f16ttt_m128n64k32m64n32k32A1T884_200_S1::inpiterb::maskiter::PitchLinearWarpRaked;
using Params = spconvlib::cumm::gemm::main::gpVolta_f16f16f16f16f16ttt_m128n64k32m64n32k32A1T884_200_S1::iterb_p::MaskTileIteratorParams;
using GlobalLoad = spconvlib::cumm::gemm::main::Volta_f16f16f16f16f16ttt_m128n64k32m64n32k32A1T884_200_S1::inpiterb::maskiter::GlobalLoad;
