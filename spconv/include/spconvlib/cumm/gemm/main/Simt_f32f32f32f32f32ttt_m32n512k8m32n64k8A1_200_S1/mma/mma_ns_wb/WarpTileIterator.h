...
#include <spconvlib/cumm/gemm/main/Simt_f32f32f32f32f32ttt_m32n512k8m32n64k8A1_200_S1/mma/mma_ns_wb/ns1/RowMajorInterleaved.h>
#include <spconvlib/cumm/gemm/main/Simt_f32f32f32f32f32ttt_m32n512k8m32n64k8A1_200_S1/mma/mma_ns_wa/ns2/RowMajorInterleaved.h>
namespace spconvlib {
namespace cumm {
namespace gemm {
namespace main {
...
using SmemLayout = spconvlib::cumm::gemm::main::Simt_f32f32f32f32f32ttt_m32n512k8m32n64k8A1_200_S1::mma::mma_ns_wb::ns1::RowMajorInterleaved;
using LaneLayout = spconvlib::cumm::gemm::main::Simt_f32f32f32f32f32ttt_m32n512k8m32n64k8A1_200_S1::mma::mma_ns_wa::ns2::RowMajorInterleaved;
struct WarpTileIterator {
  ...
  __forceinline__ __device__  WarpTileIterator(float * ptr, int warp_idx_k, int warp_idx_residual, int lane_idx)   {
    ...
    constexpr auto smem_layout = SmemLayout::from_shape({8, 512});
  ...
  __forceinline__ __device__ void tile_increment(int num)   {
    static constexpr auto smem_layout = SmemLayout::from_shape({8, 512});
