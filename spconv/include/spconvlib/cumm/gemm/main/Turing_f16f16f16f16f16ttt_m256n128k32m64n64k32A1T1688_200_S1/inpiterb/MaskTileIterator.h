...
#include <spconvlib/cumm/gemm/main/Turing_f16f16f16f16f16ttt_m256n128k32m64n64k32A1T1688_200_S1/inpiterb/maskiter/PitchLinearWarpRaked.h>
...
#include <spconvlib/cumm/gemm/main/Turing_f16f16f16f16f16ttt_m256n128k32m64n64k32A1T1688_200_S1/inpiterb/maskiter/GlobalLoad.h>
namespace spconvlib {
namespace cumm {
namespace gemm {
namespace main {
...
using ThreadMap = spconvlib::cumm::gemm::main::Turing_f16f16f16f16f16ttt_m256n128k32m64n64k32A1T1688_200_S1::inpiterb::maskiter::PitchLinearWarpRaked;
using Params = spconvlib::cumm::gemm::main::gpTuring_f16f16f16f16f16ttt_m256n128k32m64n64k32A1T1688_200_S1::iterb_p::MaskTileIteratorParams;
using GlobalLoad = spconvlib::cumm::gemm::main::Turing_f16f16f16f16f16ttt_m256n128k32m64n64k32A1T1688_200_S1::inpiterb::maskiter::GlobalLoad;
