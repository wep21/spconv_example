...
#include <spconvlib/cumm/gemm/main/Turing_f16f16f16f16f16ttt_m256n128k32m64n64k32A1T1688_200_S1/output/out_ns_smem/tmap/Out5DLinear.h>
namespace spconvlib {
namespace cumm {
namespace gemm {
namespace main {
...
using ThreadMap = spconvlib::cumm::gemm::main::Turing_f16f16f16f16f16ttt_m256n128k32m64n64k32A1T1688_200_S1::output::out_ns_smem::tmap::Out5DLinear;
