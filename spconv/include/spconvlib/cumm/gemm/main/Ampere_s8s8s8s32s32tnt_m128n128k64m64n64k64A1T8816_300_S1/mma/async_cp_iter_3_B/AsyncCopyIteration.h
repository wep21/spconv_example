#pragma once
#include <spconvlib/cumm/gemm/main/Ampere_s8s8s8s32s32tnt_m128n128k64m64n64k64A1T8816_300_S1/mma/async_cp_iter_3_B/cp_async_copy/CpAsyncCopy.h>
namespace spconvlib {
namespace cumm {
namespace gemm {
namespace main {
...
using CpAsyncCp = spconvlib::cumm::gemm::main::Ampere_s8s8s8s32s32tnt_m128n128k64m64n64k64A1T8816_300_S1::mma::async_cp_iter_3_B::cp_async_copy::CpAsyncCopy;
