...
#include <spconvlib/cumm/gemm/main/Ampere_s8s8s8s32s32tnt_m128n128k64m64n64k64A1T8816_300_S1/inpitera/maskiter/PitchLinearWarpRaked.h>
#include <spconvlib/cumm/gemm/main/gpAmpere_s8s8s8s32s32tnt_m128n128k64m64n64k64A1T8816_300_S1/itera_p/MaskTileIteratorParams.h>
#include <spconvlib/cumm/gemm/main/Ampere_s8s8s8s32s32tnt_m128n128k64m64n64k64A1T8816_300_S1/inpitera/maskiter/GlobalLoad.h>
namespace spconvlib {
namespace cumm {
namespace gemm {
namespace main {
...
using ThreadMap = spconvlib::cumm::gemm::main::Ampere_s8s8s8s32s32tnt_m128n128k64m64n64k64A1T8816_300_S1::inpitera::maskiter::PitchLinearWarpRaked;
using Params = spconvlib::cumm::gemm::main::gpAmpere_s8s8s8s32s32tnt_m128n128k64m64n64k64A1T8816_300_S1::itera_p::MaskTileIteratorParams;
using GlobalLoad = spconvlib::cumm::gemm::main::Ampere_s8s8s8s32s32tnt_m128n128k64m64n64k64A1T8816_300_S1::inpitera::maskiter::GlobalLoad;
struct MaskTileIterator {
  ...
  __forceinline__ __device__ void load_with_byte_offset(tv::array<int8_t, 64, 0>& frag, int64_t byte_offset)   {
