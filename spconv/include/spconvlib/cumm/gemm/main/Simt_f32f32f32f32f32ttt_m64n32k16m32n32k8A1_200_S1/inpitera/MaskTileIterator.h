...
#include <spconvlib/cumm/gemm/main/Simt_f32f32f32f32f32ttt_m64n32k16m32n32k8A1_200_S1/inpitera/maskiter/PitchLinear.h>
#include <spconvlib/cumm/gemm/main/gpSimt_f32f32f32f32f32ttt_m64n32k16m32n32k8A1_200_S1/itera_p/MaskTileIteratorParams.h>
#include <spconvlib/cumm/gemm/main/Simt_f32f32f32f32f32ttt_m64n32k16m32n32k8A1_200_S1/inpitera/maskiter/GlobalLoad.h>
namespace spconvlib {
namespace cumm {
namespace gemm {
namespace main {
...
using ThreadMap = spconvlib::cumm::gemm::main::Simt_f32f32f32f32f32ttt_m64n32k16m32n32k8A1_200_S1::inpitera::maskiter::PitchLinear;
using Params = spconvlib::cumm::gemm::main::gpSimt_f32f32f32f32f32ttt_m64n32k16m32n32k8A1_200_S1::itera_p::MaskTileIteratorParams;
using GlobalLoad = spconvlib::cumm::gemm::main::Simt_f32f32f32f32f32ttt_m64n32k16m32n32k8A1_200_S1::inpitera::maskiter::GlobalLoad;
struct MaskTileIterator {
  ...
  __forceinline__ __device__ void update_indices()   {
    ...
    for (int s = 0; s < 8; ++s){
        ...
        for (int ss = 0; ss < 1; ++ss){
            if (thread_offset_[0] + s * 8 + ss < extent_[0])
                indices_[s * 1 + ss] = 
  ...
  __forceinline__ __device__ void load_with_byte_offset(tv::array<float, 8, 0>& frag, int64_t byte_offset)   {
