...
#include <spconvlib/cumm/gemm/main/Simt_f32f32f32f32f32ttt_m64n32k16m32n32k8A1_200_S1/mma/mma_ns_wb/ns1/RowMajorInterleaved.h>
...
using SmemLayout = spconvlib::cumm::gemm::main::Simt_f32f32f32f32f32ttt_m64n32k16m32n32k8A1_200_S1::mma::mma_ns_wb::ns1::RowMajorInterleaved;
...
struct WarpTileIterator {
  ...
  __forceinline__ __device__  WarpTileIterator(float * ptr, int warp_idx_k, int warp_idx_residual, int lane_idx) : wmma_k_index_(0)  {
    ...
    constexpr auto smem_layout = SmemLayout::from_shape({16, 32});
  ...
  __forceinline__ __device__ void tile_increment(int num)   {
    static constexpr auto smem_layout = SmemLayout::from_shape({16, 32});
