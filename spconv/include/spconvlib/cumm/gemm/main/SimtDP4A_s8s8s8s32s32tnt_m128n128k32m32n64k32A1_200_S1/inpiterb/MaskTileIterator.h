...
#include <spconvlib/cumm/gemm/main/SimtDP4A_s8s8s8s32s32tnt_m128n128k32m32n64k32A1_200_S1/inpiterb/maskiter/PitchLinear.h>
...
#include <spconvlib/cumm/gemm/main/SimtDP4A_s8s8s8s32s32tnt_m128n128k32m32n64k32A1_200_S1/inpiterb/maskiter/GlobalLoad.h>
namespace spconvlib {
namespace cumm {
namespace gemm {
namespace main {
...
using ThreadMap = spconvlib::cumm::gemm::main::SimtDP4A_s8s8s8s32s32tnt_m128n128k32m32n64k32A1_200_S1::inpiterb::maskiter::PitchLinear;
using Params = spconvlib::cumm::gemm::main::gpSimtDP4A_s8s8s8s32s32tnt_m128n128k32m32n64k32A1_200_S1::iterb_p::MaskTileIteratorParams;
using GlobalLoad = spconvlib::cumm::gemm::main::SimtDP4A_s8s8s8s32s32tnt_m128n128k32m32n64k32A1_200_S1::inpiterb::maskiter::GlobalLoad;
