#pragma once
#include <spconvlib/cumm/gemm/main/Turing_s8s8s8s32s32tnt_m256n128k32m64n64k32A1T8816_200_S1/mma/mma_ns_wb/layout/MyTensorOpLayout.h>
#include <spconvlib/cumm/gemm/main/Turing_s8s8s8s32s32tnt_m256n128k32m64n64k32A1T8816_200_S1/mma/mma_ns_wb/ldsm/LdMatrix.h>
namespace spconvlib {
namespace cumm {
namespace gemm {
namespace main {
...
namespace mma {
namespace mma_ns_wb {
using TensorOpLayout = spconvlib::cumm::gemm::main::Turing_s8s8s8s32s32tnt_m256n128k32m64n64k32A1T8816_200_S1::mma::mma_ns_wb::layout::MyTensorOpLayout;
using LdMatrix = spconvlib::cumm::gemm::main::Turing_s8s8s8s32s32tnt_m256n128k32m64n64k32A1T8816_200_S1::mma::mma_ns_wb::ldsm::LdMatrix;
