...
#include <spconvlib/cumm/gemm/main/Volta_f16f16f16f16f16tnt_m128n256k32m64n64k32A1T884_200_S1/out_op/unaryop/UnaryActivation.h>
namespace spconvlib {
namespace cumm {
namespace gemm {
namespace main {
...
namespace out_op {
using UnaryOp = spconvlib::cumm::gemm::main::Volta_f16f16f16f16f16tnt_m128n256k32m64n64k32A1T884_200_S1::out_op::unaryop::UnaryActivation;
