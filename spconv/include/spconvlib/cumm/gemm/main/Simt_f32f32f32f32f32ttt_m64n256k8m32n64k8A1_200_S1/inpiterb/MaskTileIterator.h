...
#include <spconvlib/cumm/gemm/main/Simt_f32f32f32f32f32ttt_m64n256k8m32n64k8A1_200_S1/inpiterb/maskiter/GlobalLoad.h>
namespace spconvlib {
namespace cumm {
namespace gemm {
namespace main {
...
using Params = spconvlib::cumm::gemm::main::gpSimt_f32f32f32f32f32ttt_m64n256k8m32n64k8A1_200_S1::iterb_p::MaskTileIteratorParams;
using GlobalLoad = spconvlib::cumm::gemm::main::Simt_f32f32f32f32f32ttt_m64n256k8m32n64k8A1_200_S1::inpiterb::maskiter::GlobalLoad;
