#pragma once
#include <spconvlib/cumm/gemm/main/Simt_f32f32f32f32f32ttt_m64n256k8m32n64k8A1_200_S1/output/out_ns_frag/OutFragIter.h>
#include <spconvlib/cumm/gemm/main/Simt_f32f32f32f32f32ttt_m64n256k8m32n64k8A1_200_S1/output/out_ns_warp/OutWarpTileIterator.h>
#include <spconvlib/cumm/gemm/main/Simt_f32f32f32f32f32ttt_m64n256k8m32n64k8A1_200_S1/output/out_ns_smem/OutSmemLoader.h>
...
#include <spconvlib/cumm/gemm/main/Simt_f32f32f32f32f32ttt_m64n256k8m32n64k8A1_200_S1/output/out_ns_apply/ApplyOutputOp.h>
namespace spconvlib {
namespace cumm {
namespace gemm {
namespace main {
...
namespace output {
using FragIter = spconvlib::cumm::gemm::main::Simt_f32f32f32f32f32ttt_m64n256k8m32n64k8A1_200_S1::output::out_ns_frag::OutFragIter;
using OutWarpIter = spconvlib::cumm::gemm::main::Simt_f32f32f32f32f32ttt_m64n256k8m32n64k8A1_200_S1::output::out_ns_warp::OutWarpTileIterator;
using SmemLoader = spconvlib::cumm::gemm::main::Simt_f32f32f32f32f32ttt_m64n256k8m32n64k8A1_200_S1::output::out_ns_smem::OutSmemLoader;
...
using OutputStorage = spconvlib::cumm::gemm::main::Simt_f32f32f32f32f32ttt_m64n256k8m32n64k8A1_200_S1::out_smem_storage::OutputSmemStorage;
using OutputOp = spconvlib::cumm::gemm::main::Simt_f32f32f32f32f32ttt_m64n256k8m32n64k8A1_200_S1::out_op::LinearCombination;
using ApplyOp = spconvlib::cumm::gemm::main::Simt_f32f32f32f32f32ttt_m64n256k8m32n64k8A1_200_S1::output::out_ns_apply::ApplyOutputOp;
struct Output {
