...
#include <spconvlib/cumm/gemm/main/Simt_f32f32f32f32f32ttt_m64n256k8m32n64k8A1_200_S1/inpitera/maskiter/PitchLinear.h>
#include <spconvlib/cumm/gemm/main/gpSimt_f32f32f32f32f32ttt_m64n256k8m32n64k8A1_200_S1/itera_p/MaskTileIteratorParams.h>
#include <spconvlib/cumm/gemm/main/Simt_f32f32f32f32f32ttt_m64n256k8m32n64k8A1_200_S1/inpitera/maskiter/GlobalLoad.h>
namespace spconvlib {
namespace cumm {
namespace gemm {
namespace main {
...
using ThreadMap = spconvlib::cumm::gemm::main::Simt_f32f32f32f32f32ttt_m64n256k8m32n64k8A1_200_S1::inpitera::maskiter::PitchLinear;
using Params = spconvlib::cumm::gemm::main::gpSimt_f32f32f32f32f32ttt_m64n256k8m32n64k8A1_200_S1::itera_p::MaskTileIteratorParams;
using GlobalLoad = spconvlib::cumm::gemm::main::Simt_f32f32f32f32f32ttt_m64n256k8m32n64k8A1_200_S1::inpitera::maskiter::GlobalLoad;
