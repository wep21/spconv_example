...
#include <spconvlib/cumm/gemm/main/gpAmpere_s8s8s8s32s32tnt_m128n64k64m64n32k64A1T8816_300_S1/out_params_ns/tmap/Out5DLinear.h>
...
using ThreadMap = spconvlib::cumm::gemm::main::gpAmpere_s8s8s8s32s32tnt_m128n64k64m64n32k64A1T8816_300_S1::out_params_ns::tmap::Out5DLinear;
using Params = spconvlib::cumm::gemm::main::gpAmpere_s8s8s8s32s32tnt_m128n64k64m64n32k64A1T8816_300_S1::out_params_ns::OutIteratorParams;
struct OutIterator {
  int8_t * pointer_;
