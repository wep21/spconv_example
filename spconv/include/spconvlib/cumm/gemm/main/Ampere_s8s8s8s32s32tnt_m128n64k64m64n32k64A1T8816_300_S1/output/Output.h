#pragma once
#include <spconvlib/cumm/gemm/main/Ampere_s8s8s8s32s32tnt_m128n64k64m64n32k64A1T8816_300_S1/output/out_ns_frag/OutFragIterTensorOp.h>
#include <spconvlib/cumm/gemm/main/Ampere_s8s8s8s32s32tnt_m128n64k64m64n32k64A1T8816_300_S1/output/out_ns_warp/OutWarpTileIteratorTensorOpMixed.h>
#include <spconvlib/cumm/gemm/main/Ampere_s8s8s8s32s32tnt_m128n64k64m64n32k64A1T8816_300_S1/output/out_ns_smem/OutSmemLoaderMixed.h>
...
#include <spconvlib/cumm/gemm/main/Ampere_s8s8s8s32s32tnt_m128n64k64m64n32k64A1T8816_300_S1/output/out_ns_apply/ApplyOutputOp.h>
namespace spconvlib {
namespace cumm {
namespace gemm {
namespace main {
...
namespace output {
using FragIter = spconvlib::cumm::gemm::main::Ampere_s8s8s8s32s32tnt_m128n64k64m64n32k64A1T8816_300_S1::output::out_ns_frag::OutFragIterTensorOp;
using OutWarpIter = spconvlib::cumm::gemm::main::Ampere_s8s8s8s32s32tnt_m128n64k64m64n32k64A1T8816_300_S1::output::out_ns_warp::OutWarpTileIteratorTensorOpMixed;
using SmemLoader = spconvlib::cumm::gemm::main::Ampere_s8s8s8s32s32tnt_m128n64k64m64n32k64A1T8816_300_S1::output::out_ns_smem::OutSmemLoaderMixed;
...
using OutputStorage = spconvlib::cumm::gemm::main::Ampere_s8s8s8s32s32tnt_m128n64k64m64n32k64A1T8816_300_S1::out_smem_storage::OutputSmemStorage;
...
using ApplyOp = spconvlib::cumm::gemm::main::Ampere_s8s8s8s32s32tnt_m128n64k64m64n32k64A1T8816_300_S1::output::out_ns_apply::ApplyOutputOp;
struct Output {
