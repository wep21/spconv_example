...
#include <spconvlib/cumm/gemm/main/gpSimt_f32f32f32f32f32ttt_m32n32k32m32n32k8A1_200_S1/out_params_ns/tmap/Out5DLinear.h>
...
using ThreadMap = spconvlib::cumm::gemm::main::gpSimt_f32f32f32f32f32ttt_m32n32k32m32n32k8A1_200_S1::out_params_ns::tmap::Out5DLinear;
using Params = spconvlib::cumm::gemm::main::gpSimt_f32f32f32f32f32ttt_m32n32k32m32n32k8A1_200_S1::out_params_ns::OutIteratorParams;
struct OutIterator {
  float * pointer_;
