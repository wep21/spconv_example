...
#include <spconvlib/cumm/gemm/main/Simt_f16f16f16f32f32tnt_m64n64k8m32n32k8A1_200_S1/inpiterb/maskiter/PitchLinear.h>
#include <spconvlib/cumm/gemm/main/gpSimt_f16f16f16f32f32tnt_m64n64k8m32n32k8A1_200_S1/iterb_p/MaskTileIteratorParams.h>
#include <spconvlib/cumm/gemm/main/Simt_f16f16f16f32f32tnt_m64n64k8m32n32k8A1_200_S1/inpiterb/maskiter/GlobalLoad.h>
namespace spconvlib {
namespace cumm {
namespace gemm {
namespace main {
...
using ThreadMap = spconvlib::cumm::gemm::main::Simt_f16f16f16f32f32tnt_m64n64k8m32n32k8A1_200_S1::inpiterb::maskiter::PitchLinear;
using Params = spconvlib::cumm::gemm::main::gpSimt_f16f16f16f32f32tnt_m64n64k8m32n32k8A1_200_S1::iterb_p::MaskTileIteratorParams;
using GlobalLoad = spconvlib::cumm::gemm::main::Simt_f16f16f16f32f32tnt_m64n64k8m32n32k8A1_200_S1::inpiterb::maskiter::GlobalLoad;
