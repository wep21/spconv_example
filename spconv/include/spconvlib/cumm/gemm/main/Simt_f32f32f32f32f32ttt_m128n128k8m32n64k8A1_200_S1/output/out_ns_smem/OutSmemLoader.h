...
#include <spconvlib/cumm/gemm/main/Simt_f32f32f32f32f32ttt_m128n128k8m32n64k8A1_200_S1/output/out_ns_smem/tmap/Out5DLinear.h>
namespace spconvlib {
namespace cumm {
namespace gemm {
namespace main {
...
using ThreadMap = spconvlib::cumm::gemm::main::Simt_f32f32f32f32f32ttt_m128n128k8m32n64k8A1_200_S1::output::out_ns_smem::tmap::Out5DLinear;
