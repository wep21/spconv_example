...
#include <spconvlib/cumm/gemm/main/gpSimt_f16f16f16f32f32tnt_m128n128k8m32n64k8A1_200_S1/out_params_ns/tmap/Out5DLinear.h>
...
using ThreadMap = spconvlib::cumm::gemm::main::gpSimt_f16f16f16f32f32tnt_m128n128k8m32n64k8A1_200_S1::out_params_ns::tmap::Out5DLinear;
using Params = spconvlib::cumm::gemm::main::gpSimt_f16f16f16f32f32tnt_m128n128k8m32n64k8A1_200_S1::out_params_ns::OutIteratorParams;
struct OutIterator {
  tv::half_t * pointer_;
