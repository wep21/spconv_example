...
struct OutWarpTileIterator {
  ...
  __forceinline__ __device__ void store_with_pointer_offset(tv::array<int32_t, 4, 0> const& frag, int32_t pointer_offset)   {
  ...
  __forceinline__ __device__ void store(tv::array<int32_t, 4, 0> const& frag)   {
