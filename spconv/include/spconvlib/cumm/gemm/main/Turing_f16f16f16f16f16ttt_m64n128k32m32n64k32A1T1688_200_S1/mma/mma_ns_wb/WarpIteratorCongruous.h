...
#include <spconvlib/cumm/gemm/main/Turing_f16f16f16f16f16ttt_m64n128k32m32n64k32A1T1688_200_S1/mma/mma_ns_wb/ldsm/LdMatrix.h>
namespace spconvlib {
namespace cumm {
namespace gemm {
namespace main {
...
namespace mma {
namespace mma_ns_wb {
using TensorOpLayout = spconvlib::cumm::gemm::main::Turing_f16f16f16f16f16ttt_m64n128k32m32n64k32A1T1688_200_S1::mma::mma_ns_wb::layout::MyTensorOpLayout;
using LdMatrix = spconvlib::cumm::gemm::main::Turing_f16f16f16f16f16ttt_m64n128k32m32n64k32A1T1688_200_S1::mma::mma_ns_wb::ldsm::LdMatrix;
