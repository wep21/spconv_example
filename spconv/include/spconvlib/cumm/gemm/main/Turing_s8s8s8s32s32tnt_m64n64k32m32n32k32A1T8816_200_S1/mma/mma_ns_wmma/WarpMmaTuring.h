...
#include <spconvlib/cumm/gemm/main/Turing_s8s8s8s32s32tnt_m64n64k32m32n32k32A1T8816_200_S1/mma/mma_ns_wmma/tensorop/MmaSync.h>
namespace spconvlib {
namespace cumm {
namespace gemm {
namespace main {
...
using InstMma = spconvlib::cumm::gemm::main::Turing_s8s8s8s32s32tnt_m64n64k32m32n32k32A1T8816_200_S1::mma::mma_ns_wmma::tensorop::MmaSync;
