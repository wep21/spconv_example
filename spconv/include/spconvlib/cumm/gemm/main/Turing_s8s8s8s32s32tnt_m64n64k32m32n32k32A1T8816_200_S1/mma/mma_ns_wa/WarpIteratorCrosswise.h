#pragma once
#include <spconvlib/cumm/gemm/main/Turing_s8s8s8s32s32tnt_m64n64k32m32n32k32A1T8816_200_S1/mma/mma_ns_wa/layout/MyTensorOpLayout.h>
#include <spconvlib/cumm/gemm/main/Turing_s8s8s8s32s32tnt_m64n64k32m32n32k32A1T8816_200_S1/mma/mma_ns_wa/ldsm/LdMatrix.h>
namespace spconvlib {
namespace cumm {
namespace gemm {
namespace main {
...
namespace mma {
namespace mma_ns_wa {
using TensorOpLayout = spconvlib::cumm::gemm::main::Turing_s8s8s8s32s32tnt_m64n64k32m32n32k32A1T8816_200_S1::mma::mma_ns_wa::layout::MyTensorOpLayout;
using LdMatrix = spconvlib::cumm::gemm::main::Turing_s8s8s8s32s32tnt_m64n64k32m32n32k32A1T8816_200_S1::mma::mma_ns_wa::ldsm::LdMatrix;
