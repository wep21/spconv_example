...
#include <spconvlib/cumm/gemm/main/SimtDP4A_s8s8s8s32s32tnt_m64n128k32m32n64k32A1_200_S1/mma/mma_ns_wb/ns1/RowMajorInterleaved.h>
#include <spconvlib/cumm/gemm/main/SimtDP4A_s8s8s8s32s32tnt_m64n128k32m32n64k32A1_200_S1/mma/mma_ns_wa/ns2/RowMajorInterleaved.h>
namespace spconvlib {
namespace cumm {
namespace gemm {
namespace main {
...
using SmemLayout = spconvlib::cumm::gemm::main::SimtDP4A_s8s8s8s32s32tnt_m64n128k32m32n64k32A1_200_S1::mma::mma_ns_wb::ns1::RowMajorInterleaved;
using LaneLayout = spconvlib::cumm::gemm::main::SimtDP4A_s8s8s8s32s32tnt_m64n128k32m32n64k32A1_200_S1::mma::mma_ns_wa::ns2::RowMajorInterleaved;
