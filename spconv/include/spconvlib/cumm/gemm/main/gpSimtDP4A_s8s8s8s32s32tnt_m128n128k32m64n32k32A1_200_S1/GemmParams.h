...
#include <spconvlib/cumm/gemm/main/gpSimtDP4A_s8s8s8s32s32tnt_m128n128k32m64n32k32A1_200_S1/gemmutils/GemmUtils.h>
#include <spconvlib/cumm/gemm/main/gpSimtDP4A_s8s8s8s32s32tnt_m128n128k32m64n32k32A1_200_S1/itera_p/MaskTileIteratorParams.h>
#include <spconvlib/cumm/gemm/main/gpSimtDP4A_s8s8s8s32s32tnt_m128n128k32m64n32k32A1_200_S1/iterb_p/MaskTileIteratorParams.h>
...
namespace gemm {
namespace main {
namespace gpSimtDP4A_s8s8s8s32s32tnt_m128n128k32m64n32k32A1_200_S1 {
using TensorViewNVRTC = spconvlib::cumm::common::TensorViewNVRTC;
using GemmBasic = spconvlib::cumm::common::GemmBasic;
using GemmUtilsCPU = spconvlib::cumm::gemm::utils::GemmUtilsCPU;
using GemmUtils = spconvlib::cumm::gemm::main::gpSimtDP4A_s8s8s8s32s32tnt_m128n128k32m64n32k32A1_200_S1::gemmutils::GemmUtils;
using IterAParams = spconvlib::cumm::gemm::main::gpSimtDP4A_s8s8s8s32s32tnt_m128n128k32m64n32k32A1_200_S1::itera_p::MaskTileIteratorParams;
using IterBParams = spconvlib::cumm::gemm::main::gpSimtDP4A_s8s8s8s32s32tnt_m128n128k32m64n32k32A1_200_S1::iterb_p::MaskTileIteratorParams;
using OutIterParams = spconvlib::cumm::gemm::main::gpSimtDP4A_s8s8s8s32s32tnt_m128n128k32m64n32k32A1_200_S1::out_params_ns::OutIteratorParams;
struct GemmParams {
