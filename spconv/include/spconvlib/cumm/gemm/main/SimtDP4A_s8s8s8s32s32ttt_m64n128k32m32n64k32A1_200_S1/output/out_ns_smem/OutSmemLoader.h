...
#include <spconvlib/cumm/gemm/main/SimtDP4A_s8s8s8s32s32ttt_m64n128k32m32n64k32A1_200_S1/output/out_ns_smem/tmap/Out5DLinear.h>
namespace spconvlib {
namespace cumm {
namespace gemm {
namespace main {
...
using ThreadMap = spconvlib::cumm::gemm::main::SimtDP4A_s8s8s8s32s32ttt_m64n128k32m32n64k32A1_200_S1::output::out_ns_smem::tmap::Out5DLinear;
