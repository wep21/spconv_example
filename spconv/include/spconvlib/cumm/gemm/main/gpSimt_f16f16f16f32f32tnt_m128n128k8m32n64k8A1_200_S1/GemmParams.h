...
#include <spconvlib/cumm/gemm/main/gpSimt_f16f16f16f32f32tnt_m128n128k8m32n64k8A1_200_S1/gemmutils/GemmUtils.h>
#include <spconvlib/cumm/gemm/main/gpSimt_f16f16f16f32f32tnt_m128n128k8m32n64k8A1_200_S1/itera_p/MaskTileIteratorParams.h>
#include <spconvlib/cumm/gemm/main/gpSimt_f16f16f16f32f32tnt_m128n128k8m32n64k8A1_200_S1/iterb_p/MaskTileIteratorParams.h>
#include <spconvlib/cumm/gemm/main/gpSimt_f16f16f16f32f32tnt_m128n128k8m32n64k8A1_200_S1/out_params_ns/OutIteratorParams.h>
namespace spconvlib {
namespace cumm {
namespace gemm {
namespace main {
...
using GemmUtils = spconvlib::cumm::gemm::main::gpSimt_f16f16f16f32f32tnt_m128n128k8m32n64k8A1_200_S1::gemmutils::GemmUtils;
using IterAParams = spconvlib::cumm::gemm::main::gpSimt_f16f16f16f32f32tnt_m128n128k8m32n64k8A1_200_S1::itera_p::MaskTileIteratorParams;
using IterBParams = spconvlib::cumm::gemm::main::gpSimt_f16f16f16f32f32tnt_m128n128k8m32n64k8A1_200_S1::iterb_p::MaskTileIteratorParams;
using OutIterParams = spconvlib::cumm::gemm::main::gpSimt_f16f16f16f32f32tnt_m128n128k8m32n64k8A1_200_S1::out_params_ns::OutIteratorParams;
struct GemmParams {
