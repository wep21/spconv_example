...
#include <spconvlib/cumm/gemm/main/Simt_f16f16f16f32f32tnt_m64n128k16m32n64k8A1_200_S1/output/out_ns_smem/tmap/Out5DLinear.h>
namespace spconvlib {
namespace cumm {
namespace gemm {
namespace main {
...
using ThreadMap = spconvlib::cumm::gemm::main::Simt_f16f16f16f32f32tnt_m64n128k16m32n64k8A1_200_S1::output::out_ns_smem::tmap::Out5DLinear;
        ...
        for (int group = 0; group < 1; ++group) {
            ...
            for (int row = 0; row < 1; ++row) {
                const float * cur_pointer =
                    pointer_ + row * 1 * 161 + group * 1 * 161 +
