...
#include <spconvlib/cumm/gemm/main/Simt_f32f32f32f32f32tnt_m128n64k8m64n32k8A1_200_S1/inpitera/maskiter/GlobalLoad.h>
namespace spconvlib {
namespace cumm {
namespace gemm {
namespace main {
...
using Params = spconvlib::cumm::gemm::main::gpSimt_f32f32f32f32f32tnt_m128n64k8m64n32k8A1_200_S1::itera_p::MaskTileIteratorParams;
using GlobalLoad = spconvlib::cumm::gemm::main::Simt_f32f32f32f32f32tnt_m128n64k8m64n32k8A1_200_S1::inpitera::maskiter::GlobalLoad;
