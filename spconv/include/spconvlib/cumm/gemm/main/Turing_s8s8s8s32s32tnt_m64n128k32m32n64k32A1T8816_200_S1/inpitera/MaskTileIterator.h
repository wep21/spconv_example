...
#include <spconvlib/cumm/gemm/main/Turing_s8s8s8s32s32tnt_m64n128k32m32n64k32A1T8816_200_S1/inpitera/maskiter/PitchLinearWarpRaked.h>
...
#include <spconvlib/cumm/gemm/main/Turing_s8s8s8s32s32tnt_m64n128k32m32n64k32A1T8816_200_S1/inpitera/maskiter/GlobalLoad.h>
namespace spconvlib {
namespace cumm {
namespace gemm {
namespace main {
...
using ThreadMap = spconvlib::cumm::gemm::main::Turing_s8s8s8s32s32tnt_m64n128k32m32n64k32A1T8816_200_S1::inpitera::maskiter::PitchLinearWarpRaked;
using Params = spconvlib::cumm::gemm::main::gpTuring_s8s8s8s32s32tnt_m64n128k32m32n64k32A1T8816_200_S1::itera_p::MaskTileIteratorParams;
using GlobalLoad = spconvlib::cumm::gemm::main::Turing_s8s8s8s32s32tnt_m64n128k32m32n64k32A1T8816_200_S1::inpitera::maskiter::GlobalLoad;
