...
#include <spconvlib/cumm/gemm/main/gpTuring_s8s8s8s32s32tnt_m64n128k32m32n64k32A1T8816_200_S1/out_params_ns/tmap/Out5DLinear.h>
...
using ThreadMap = spconvlib::cumm::gemm::main::gpTuring_s8s8s8s32s32tnt_m64n128k32m32n64k32A1T8816_200_S1::out_params_ns::tmap::Out5DLinear;
using Params = spconvlib::cumm::gemm::main::gpTuring_s8s8s8s32s32tnt_m64n128k32m32n64k32A1T8816_200_S1::out_params_ns::OutIteratorParams;
struct OutIterator {
  int8_t * pointer_;
