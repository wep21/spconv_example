...
#include <spconvlib/cumm/gemm/main/Simt_f32f32f32f32f32ttt_m32n64k16m32n32k8A1_200_S1/mma/mma_ns_wmma/instmma/InstMma.h>
namespace spconvlib {
namespace cumm {
namespace gemm {
namespace main {
...
using InstMma = spconvlib::cumm::gemm::main::Simt_f32f32f32f32f32ttt_m32n64k16m32n32k8A1_200_S1::mma::mma_ns_wmma::instmma::InstMma;
struct WarpMmaSimt {
