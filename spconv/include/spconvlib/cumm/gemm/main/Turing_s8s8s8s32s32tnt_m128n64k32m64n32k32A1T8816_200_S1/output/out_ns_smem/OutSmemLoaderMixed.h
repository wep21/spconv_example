...
#include <spconvlib/cumm/gemm/main/Turing_s8s8s8s32s32tnt_m128n64k32m64n32k32A1T8816_200_S1/output/out_ns_smem/tmap/Out5DLinear.h>
namespace spconvlib {
namespace cumm {
namespace gemm {
namespace main {
...
using ThreadMap = spconvlib::cumm::gemm::main::Turing_s8s8s8s32s32tnt_m128n64k32m64n32k32A1T8816_200_S1::output::out_ns_smem::tmap::Out5DLinear;
