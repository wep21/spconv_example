...
#include <spconvlib/cumm/gemm/main/Turing_s8s8s8s32s32tnt_m128n64k32m64n32k32A1T8816_200_S1/inpiterb/maskiter/PitchLinearWarpRaked.h>
...
#include <spconvlib/cumm/gemm/main/Turing_s8s8s8s32s32tnt_m128n64k32m64n32k32A1T8816_200_S1/inpiterb/maskiter/GlobalLoad.h>
namespace spconvlib {
namespace cumm {
namespace gemm {
namespace main {
...
using ThreadMap = spconvlib::cumm::gemm::main::Turing_s8s8s8s32s32tnt_m128n64k32m64n32k32A1T8816_200_S1::inpiterb::maskiter::PitchLinearWarpRaked;
using Params = spconvlib::cumm::gemm::main::gpTuring_s8s8s8s32s32tnt_m128n64k32m64n32k32A1T8816_200_S1::iterb_p::MaskTileIteratorParams;
using GlobalLoad = spconvlib::cumm::gemm::main::Turing_s8s8s8s32s32tnt_m128n64k32m64n32k32A1T8816_200_S1::inpiterb::maskiter::GlobalLoad;
