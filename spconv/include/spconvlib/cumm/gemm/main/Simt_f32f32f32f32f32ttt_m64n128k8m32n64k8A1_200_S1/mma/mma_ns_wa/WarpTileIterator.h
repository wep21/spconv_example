...
#include <spconvlib/cumm/gemm/main/Simt_f32f32f32f32f32ttt_m64n128k8m32n64k8A1_200_S1/mma/mma_ns_wa/ns1/RowMajorInterleaved.h>
...
using SmemLayout = spconvlib::cumm::gemm::main::Simt_f32f32f32f32f32ttt_m64n128k8m32n64k8A1_200_S1::mma::mma_ns_wa::ns1::RowMajorInterleaved;
...
struct WarpTileIterator {
  ...
  __forceinline__ __device__  WarpTileIterator(float * ptr, int warp_idx_k, int warp_idx_residual, int lane_idx)   {
    ...
    constexpr auto smem_layout = SmemLayout::from_shape({8, 68});
  ...
  __forceinline__ __device__ void tile_increment(int num)   {
    static constexpr auto smem_layout = SmemLayout::from_shape({8, 68});
