...
#include <spconvlib/cumm/gemm/main/Simt_f32f32f32f32f32ttt_m64n128k8m32n64k8A1_200_S1/mma/mma_ns_wb/ns1/RowMajorInterleaved.h>
#include <spconvlib/cumm/gemm/main/Simt_f32f32f32f32f32ttt_m64n128k8m32n64k8A1_200_S1/mma/mma_ns_wa/ns2/RowMajorInterleaved.h>
namespace spconvlib {
namespace cumm {
namespace gemm {
namespace main {
...
using SmemLayout = spconvlib::cumm::gemm::main::Simt_f32f32f32f32f32ttt_m64n128k8m32n64k8A1_200_S1::mma::mma_ns_wb::ns1::RowMajorInterleaved;
using LaneLayout = spconvlib::cumm::gemm::main::Simt_f32f32f32f32f32ttt_m64n128k8m32n64k8A1_200_S1::mma::mma_ns_wa::ns2::RowMajorInterleaved;
