...
#include <spconvlib/cumm/gemm/main/gpVolta_f16f16f16f16f16ttt_m64n128k32m32n64k32A1T884_200_S1/out_params_ns/tmap/Out5DLinear.h>
...
using ThreadMap = spconvlib::cumm::gemm::main::gpVolta_f16f16f16f16f16ttt_m64n128k32m32n64k32A1T884_200_S1::out_params_ns::tmap::Out5DLinear;
using Params = spconvlib::cumm::gemm::main::gpVolta_f16f16f16f16f16ttt_m64n128k32m32n64k32A1T884_200_S1::out_params_ns::OutIteratorParams;
struct OutIterator {
  tv::half_t * pointer_;
