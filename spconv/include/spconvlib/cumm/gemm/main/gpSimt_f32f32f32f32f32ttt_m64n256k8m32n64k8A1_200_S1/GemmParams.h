...
#include <spconvlib/cumm/gemm/main/gpSimt_f32f32f32f32f32ttt_m64n256k8m32n64k8A1_200_S1/gemmutils/GemmUtils.h>
#include <spconvlib/cumm/gemm/main/gpSimt_f32f32f32f32f32ttt_m64n256k8m32n64k8A1_200_S1/itera_p/MaskTileIteratorParams.h>
#include <spconvlib/cumm/gemm/main/gpSimt_f32f32f32f32f32ttt_m64n256k8m32n64k8A1_200_S1/iterb_p/MaskTileIteratorParams.h>
#include <spconvlib/cumm/gemm/main/gpSimt_f32f32f32f32f32ttt_m64n256k8m32n64k8A1_200_S1/out_params_ns/OutIteratorParams.h>
namespace spconvlib {
namespace cumm {
namespace gemm {
namespace main {
namespace gpSimt_f32f32f32f32f32ttt_m64n256k8m32n64k8A1_200_S1 {
using TensorViewNVRTC = spconvlib::cumm::common::TensorViewNVRTC;
using GemmBasic = spconvlib::cumm::common::GemmBasic;
using GemmUtilsCPU = spconvlib::cumm::gemm::utils::GemmUtilsCPU;
using GemmUtils = spconvlib::cumm::gemm::main::gpSimt_f32f32f32f32f32ttt_m64n256k8m32n64k8A1_200_S1::gemmutils::GemmUtils;
using IterAParams = spconvlib::cumm::gemm::main::gpSimt_f32f32f32f32f32ttt_m64n256k8m32n64k8A1_200_S1::itera_p::MaskTileIteratorParams;
using IterBParams = spconvlib::cumm::gemm::main::gpSimt_f32f32f32f32f32ttt_m64n256k8m32n64k8A1_200_S1::iterb_p::MaskTileIteratorParams;
using OutIterParams = spconvlib::cumm::gemm::main::gpSimt_f32f32f32f32f32ttt_m64n256k8m32n64k8A1_200_S1::out_params_ns::OutIteratorParams;
struct GemmParams {
  ...
  __host__ __device__ inline  GemmParams(int m, int n, int k, const float* A, const float* B, float* C, const float* D, int64_t stride_A, int64_t stride_B, int64_t stride_C, int64_t stride_D, const int* IndiceA, const int* IndiceC, const int* IndiceD, float alpha = float(1), float beta = float(0), float act_alpha = float(0), float act_beta = float(0), tv::gemm::Activation act_type = tv::gemm::Activation::kNone, int split_k_slices = 1) : m(m), n(n), k(k), ptr_A(A), ptr_B(B), ptr_C(C), ptr_D(D), stride_A(stride_A), stride_B(stride_B), stride_C(stride_C), stride_D(stride_D), alpha(alpha), beta(beta), act_alpha(act_alpha), act_beta(act_beta), act_type(act_type)  {
    ...
    auto grid_dims_arr = GemmUtilsCPU::get_logical_tile_count(m, n, k, 64, 256, split_k_slices);
    // tv::printf2_once(m, n, k, 64, 256, split_k_slices, grid_dims_arr[0], grid_dims_arr[1], grid_dims_arr[2]);
