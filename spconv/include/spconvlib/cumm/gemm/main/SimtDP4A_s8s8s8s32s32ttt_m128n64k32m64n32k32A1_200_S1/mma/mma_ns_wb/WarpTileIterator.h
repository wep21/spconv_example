...
#include <spconvlib/cumm/gemm/main/SimtDP4A_s8s8s8s32s32ttt_m128n64k32m64n32k32A1_200_S1/mma/mma_ns_wb/ns1/RowMajorInterleaved.h>
...
using SmemLayout = spconvlib::cumm::gemm::main::SimtDP4A_s8s8s8s32s32ttt_m128n64k32m64n32k32A1_200_S1::mma::mma_ns_wb::ns1::RowMajorInterleaved;
...
struct WarpTileIterator {
  ...
  __forceinline__ __device__  WarpTileIterator(int8_t * ptr, int warp_idx_k, int warp_idx_residual, int lane_idx)   {
    ...
    constexpr auto smem_layout = SmemLayout::from_shape({32, 64});
  ...
  __forceinline__ __device__ void tile_increment(int num)   {
    static constexpr auto smem_layout = SmemLayout::from_shape({32, 64});
