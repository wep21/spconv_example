...
#include <spconvlib/cumm/gemm/main/SimtDP4A_s8s8s8s32s32ttt_m128n64k32m64n32k32A1_200_S1/mma/mma_ns_wmma/instmma/InstMma.h>
namespace spconvlib {
namespace cumm {
namespace gemm {
namespace main {
...
using InstMma = spconvlib::cumm::gemm::main::SimtDP4A_s8s8s8s32s32ttt_m128n64k32m64n32k32A1_200_S1::mma::mma_ns_wmma::instmma::InstMma;
struct WarpMmaSimt {
