...
#include <spconvlib/cumm/gemm/main/SimtDP4A_s8s8s8s32s32ttt_m128n64k32m64n32k32A1_200_S1/inpitera/maskiter/PitchLinear.h>
...
#include <spconvlib/cumm/gemm/main/SimtDP4A_s8s8s8s32s32ttt_m128n64k32m64n32k32A1_200_S1/inpitera/maskiter/GlobalLoad.h>
namespace spconvlib {
namespace cumm {
namespace gemm {
namespace main {
...
using ThreadMap = spconvlib::cumm::gemm::main::SimtDP4A_s8s8s8s32s32ttt_m128n64k32m64n32k32A1_200_S1::inpitera::maskiter::PitchLinear;
using Params = spconvlib::cumm::gemm::main::gpSimtDP4A_s8s8s8s32s32ttt_m128n64k32m64n32k32A1_200_S1::itera_p::MaskTileIteratorParams;
using GlobalLoad = spconvlib::cumm::gemm::main::SimtDP4A_s8s8s8s32s32ttt_m128n64k32m64n32k32A1_200_S1::inpitera::maskiter::GlobalLoad;
