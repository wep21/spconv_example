...
#include <spconvlib/cumm/conv/main/cpTuring_s8s8s8s32f32tnt_m64n128k32m32n64k32A1T8816_200_C301LLL_SKD_S8/out_params_ns/tmap/Out5DLinear.h>
...
using ThreadMap = spconvlib::cumm::conv::main::cpTuring_s8s8s8s32f32tnt_m64n128k32m32n64k32A1T8816_200_C301LLL_SKD_S8::out_params_ns::tmap::Out5DLinear;
using Params = spconvlib::cumm::conv::main::cpTuring_s8s8s8s32f32tnt_m64n128k32m32n64k32A1T8816_200_C301LLL_SKD_S8::out_params_scalebias_ns::OutIteratorParams;
struct OutIterator {
