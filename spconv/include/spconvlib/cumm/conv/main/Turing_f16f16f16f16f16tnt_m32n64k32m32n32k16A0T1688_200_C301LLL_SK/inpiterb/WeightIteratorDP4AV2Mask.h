...
#include <spconvlib/cumm/conv/main/Turing_f16f16f16f16f16tnt_m32n64k32m32n32k16A0T1688_200_C301LLL_SK/inpiterb/gload/GlobalLoad.h>
#include <spconvlib/cumm/conv/main/Turing_f16f16f16f16f16tnt_m32n64k32m32n32k16A0T1688_200_C301LLL_SK/inpiterb/mask/Mask.h>
#include <spconvlib/cumm/conv/main/Turing_f16f16f16f16f16tnt_m32n64k32m32n32k16A0T1688_200_C301LLL_SK/inpiterb/tmap/PitchLinearWarpRaked.h>
#include <spconvlib/cumm/conv/main/cpTuring_f16f16f16f16f16tnt_m32n64k32m32n32k16A0T1688_200_C301LLL_SK/cp/ConvProblem.h>
#include <spconvlib/cumm/conv/main/cpTuring_f16f16f16f16f16tnt_m32n64k32m32n32k16A0T1688_200_C301LLL_SK/iterb_p/WeightOptParams.h>
...
using GlobalLoad = spconvlib::cumm::conv::main::Turing_f16f16f16f16f16tnt_m32n64k32m32n32k16A0T1688_200_C301LLL_SK::inpiterb::gload::GlobalLoad;
using Mask = spconvlib::cumm::conv::main::Turing_f16f16f16f16f16tnt_m32n64k32m32n32k16A0T1688_200_C301LLL_SK::inpiterb::mask::Mask;
using ThreadMap = spconvlib::cumm::conv::main::Turing_f16f16f16f16f16tnt_m32n64k32m32n32k16A0T1688_200_C301LLL_SK::inpiterb::tmap::PitchLinearWarpRaked;
...
using Params = spconvlib::cumm::conv::main::cpTuring_f16f16f16f16f16tnt_m32n64k32m32n32k16A0T1688_200_C301LLL_SK::iterb_p::WeightOptParams;
using Layout = spconvlib::cumm::conv::main::cpTuring_f16f16f16f16f16tnt_m32n64k32m32n32k16A0T1688_200_C301LLL_SK::lb::TensorGeneric;
struct WeightIteratorDP4AV2Mask {
  ...
  __forceinline__ __device__  WeightIteratorDP4AV2Mask(Params const& params, ConvProblem const& problem_size, const tv::half_t * ptr, int thread_id, const tv::array<int, 2>& threadblock_offset) : params_(params), problem_size_(problem_size), pointer_(reinterpret_cast<const char *>(ptr))  {
    ...
    mask_.set_coord((thread_offset[0] + 8 < problem_size.K) && (thread_offset[1] + 0 < problem_size.C), 1, 0, 0, 0);
    mask_.set_coord((thread_offset[0] + 8 < problem_size.K) && (thread_offset[1] + 1 < problem_size.C), 1, 0, 0, 1);
    mask_.set_coord((thread_offset[0] + 8 < problem_size.K) && (thread_offset[1] + 2 < problem_size.C), 1, 0, 0, 2);
    mask_.set_coord((thread_offset[0] + 8 < problem_size.K) && (thread_offset[1] + 3 < problem_size.C), 1, 0, 0, 3);
    mask_.set_coord((thread_offset[0] + 8 < problem_size.K) && (thread_offset[1] + 4 < problem_size.C), 1, 0, 0, 4);
    mask_.set_coord((thread_offset[0] + 8 < problem_size.K) && (thread_offset[1] + 5 < problem_size.C), 1, 0, 0, 5);
    mask_.set_coord((thread_offset[0] + 8 < problem_size.K) && (thread_offset[1] + 6 < problem_size.C), 1, 0, 0, 6);
    mask_.set_coord((thread_offset[0] + 8 < problem_size.K) && (thread_offset[1] + 7 < problem_size.C), 1, 0, 0, 7);
  ...
  __forceinline__ __device__ const tv::array<tv::half_t, 1> * get(int stride, int contig, int ss)  const {
    ...
    return reinterpret_cast<const tv::array<tv::half_t, 1> *>(pointer_ + contig * 32 * 16 / 8);
  }
