#pragma once
#include <spconvlib/cumm/conv/main/Ampere_s8s8s8s32f32tnt_m128n256k64m64n128k64A1T16832_200_C301LLL_SK_S8/mma/mma_ns_wb/layout/MyTensorOpLayout.h>
#include <spconvlib/cumm/conv/main/Ampere_s8s8s8s32f32tnt_m128n256k64m64n128k64A1T16832_200_C301LLL_SK_S8/mma/mma_ns_wb/ldsm/LdMatrix.h>
namespace spconvlib {
namespace cumm {
namespace conv {
namespace main {
...
namespace mma {
namespace mma_ns_wb {
using TensorOpLayout = spconvlib::cumm::conv::main::Ampere_s8s8s8s32f32tnt_m128n256k64m64n128k64A1T16832_200_C301LLL_SK_S8::mma::mma_ns_wb::layout::MyTensorOpLayout;
using LdMatrix = spconvlib::cumm::conv::main::Ampere_s8s8s8s32f32tnt_m128n256k64m64n128k64A1T16832_200_C301LLL_SK_S8::mma::mma_ns_wb::ldsm::LdMatrix;
