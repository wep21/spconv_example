...
struct ApplyOutputOp {
  __forceinline__ __device__ static void apply_output_with_int8_operator(tv::array<int8_t, 32, 0> & output_fragment, OutputOp const & output_op, tv::array<int32_t, 32, 0> const & aligned_accum_fragment, tv::array<int8_t, 32, 0> const & source_fragment, tv::array<tv::half_t, 32, 0> const & int8_bias_fragment, tv::array<tv::half_t, 32, 0> const & int8_scale_fragment)   {
    ...
    using ScaleAccessType = tv::array<typename tv::array<tv::half_t, 32, 0>::value_type, 16, 0>;
  ...
  __forceinline__ __device__ static void apply_output_with_int8_operator_no_source(tv::array<int8_t, 32, 0> & output_fragment, OutputOp const & output_op, tv::array<int32_t, 32, 0> const & aligned_accum_fragment, tv::array<tv::half_t, 32, 0> const & int8_bias_fragment, tv::array<tv::half_t, 32, 0> const & int8_scale_fragment)   {
