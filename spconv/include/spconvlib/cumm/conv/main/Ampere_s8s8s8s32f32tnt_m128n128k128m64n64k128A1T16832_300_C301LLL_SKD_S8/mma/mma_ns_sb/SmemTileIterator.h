...
using Layout = spconvlib::cumm::conv::main::Ampere_s8s8s8s32f32tnt_m128n128k128m64n64k128A1T16832_300_C301LLL_SKD_S8::mma::mma_ns_wb::layout::MyTensorOpLayout;
struct SmemTileIterator {
  tv::array<int8_t, 16> * pointer_[2];
  ...
  __forceinline__ __device__ tv::array<int8_t, 16> * get(int s, int c)  const {
    tv::array<int8_t, 16> * access_ptr = pointer_[s & 1];
  ...
  __forceinline__ __device__ void store_with_pointer_offset(tv::array<int8_t, 128, 0> const& frag, int32_t pointer_offset)   {
    store_with_byte_offset(frag, pointer_offset * 8 / 8);
  }
  __forceinline__ __device__ void store_with_byte_offset(tv::array<int8_t, 128, 0> const& frag, int32_t byte_offset)   {
  ...
  __forceinline__ __device__ void store(tv::array<int8_t, 128, 0> const& frag)   {
