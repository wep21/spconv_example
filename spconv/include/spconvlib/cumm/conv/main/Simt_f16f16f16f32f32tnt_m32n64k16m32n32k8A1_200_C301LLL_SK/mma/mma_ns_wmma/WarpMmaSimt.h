...
#include <spconvlib/cumm/conv/main/Simt_f16f16f16f32f32tnt_m32n64k16m32n32k8A1_200_C301LLL_SK/mma/mma_ns_wmma/instmma/InstMma.h>
namespace spconvlib {
namespace cumm {
namespace conv {
namespace main {
...
using InstMma = spconvlib::cumm::conv::main::Simt_f16f16f16f32f32tnt_m32n64k16m32n32k8A1_200_C301LLL_SK::mma::mma_ns_wmma::instmma::InstMma;
struct WarpMmaSimt {
  __forceinline__ __device__ void operator()(tv::array<float, 32, 0>& D, tv::array<tv::half_t, 8, 0> const & A, tv::array<tv::half_t, 4, 0> const & B, tv::array<float, 32, 0> const & C)   {
