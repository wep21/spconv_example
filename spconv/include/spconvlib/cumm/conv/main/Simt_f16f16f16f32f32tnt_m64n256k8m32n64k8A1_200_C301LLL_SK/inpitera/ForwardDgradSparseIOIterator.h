...
#include <spconvlib/cumm/conv/main/Simt_f16f16f16f32f32tnt_m64n256k8m32n64k8A1_200_C301LLL_SK/inpitera/mask/Mask.h>
#include <spconvlib/cumm/conv/main/Simt_f16f16f16f32f32tnt_m64n256k8m32n64k8A1_200_C301LLL_SK/inpitera/gload/GlobalLoad.h>
#include <spconvlib/cumm/conv/main/Simt_f16f16f16f32f32tnt_m64n256k8m32n64k8A1_200_C301LLL_SK/inpitera/tmap/PitchLinear.h>
...
using Mask = spconvlib::cumm::conv::main::Simt_f16f16f16f32f32tnt_m64n256k8m32n64k8A1_200_C301LLL_SK::inpitera::mask::Mask;
using GlobalLoad = spconvlib::cumm::conv::main::Simt_f16f16f16f32f32tnt_m64n256k8m32n64k8A1_200_C301LLL_SK::inpitera::gload::GlobalLoad;
using ThreadMap = spconvlib::cumm::conv::main::Simt_f16f16f16f32f32tnt_m64n256k8m32n64k8A1_200_C301LLL_SK::inpitera::tmap::PitchLinear;
using ConvProblem = spconvlib::cumm::conv::main::cpSimt_f16f16f16f32f32tnt_m64n256k8m32n64k8A1_200_C301LLL_SK::cp::ConvProblem;
using Params = spconvlib::cumm::conv::main::cpSimt_f16f16f16f32f32tnt_m64n256k8m32n64k8A1_200_C301LLL_SK::itera_p::SparseParams;
  ...
  __forceinline__ __device__  ForwardDgradSparseIOIterator(Params & params, ConvProblem const& problem_size, const tv::half_t * ptr, int thread_id, const tv::array<int, 2>& threadblock_offset) : params_(params), problem_(problem_size), indice_ptr_(params.indice_ptr_)  {
    ...
    for (int s = 0; s < 2; ++s){
        ...
        for (int ss = 0; ss < 1; ++ss){
            TV_PRAGMA_UNROLL
            for (int v = 0; v < 1; ++v){
                uint32_t pred = (stride_offset_ + s * 32 + ss) < problem_.N;
                mask_[v] |= (pred << (s * 1 + ss));
            }
        }
    }
