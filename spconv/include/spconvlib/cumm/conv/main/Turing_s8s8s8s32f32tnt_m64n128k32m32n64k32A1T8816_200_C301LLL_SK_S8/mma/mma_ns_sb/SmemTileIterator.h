...
#include <spconvlib/cumm/conv/main/Turing_s8s8s8s32f32tnt_m64n128k32m32n64k32A1T8816_200_C301LLL_SK_S8/mma/mma_ns_wb/layout/MyTensorOpLayout.h>
namespace spconvlib {
namespace cumm {
namespace conv {
namespace main {
...
using Layout = spconvlib::cumm::conv::main::Turing_s8s8s8s32f32tnt_m64n128k32m32n64k32A1T8816_200_C301LLL_SK_S8::mma::mma_ns_wb::layout::MyTensorOpLayout;
