...
#include <spconvlib/cumm/conv/main/Turing_s8s8s8s32f32tnt_m64n64k32m32n32k32A0T8816_200_C301LLL_SK_S8/inpitera/mask/Mask.h>
#include <spconvlib/cumm/conv/main/Turing_s8s8s8s32f32tnt_m64n64k32m32n32k32A0T8816_200_C301LLL_SK_S8/inpitera/gload/GlobalLoad.h>
#include <spconvlib/cumm/conv/main/Turing_s8s8s8s32f32tnt_m64n64k32m32n32k32A0T8816_200_C301LLL_SK_S8/inpitera/tmap/PitchLinearWarpRaked.h>
...
using Mask = spconvlib::cumm::conv::main::Turing_s8s8s8s32f32tnt_m64n64k32m32n32k32A0T8816_200_C301LLL_SK_S8::inpitera::mask::Mask;
using GlobalLoad = spconvlib::cumm::conv::main::Turing_s8s8s8s32f32tnt_m64n64k32m32n32k32A0T8816_200_C301LLL_SK_S8::inpitera::gload::GlobalLoad;
using ThreadMap = spconvlib::cumm::conv::main::Turing_s8s8s8s32f32tnt_m64n64k32m32n32k32A0T8816_200_C301LLL_SK_S8::inpitera::tmap::PitchLinearWarpRaked;
...
using Params = spconvlib::cumm::conv::main::cpTuring_s8s8s8s32f32tnt_m64n64k32m32n32k32A0T8816_200_C301LLL_SK_S8::itera_p::SparseParams;
