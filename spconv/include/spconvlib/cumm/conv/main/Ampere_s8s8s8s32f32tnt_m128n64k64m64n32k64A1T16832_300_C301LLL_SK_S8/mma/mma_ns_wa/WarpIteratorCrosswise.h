#pragma once
#include <spconvlib/cumm/conv/main/Ampere_s8s8s8s32f32tnt_m128n64k64m64n32k64A1T16832_300_C301LLL_SK_S8/mma/mma_ns_wa/layout/MyTensorOpLayout.h>
#include <spconvlib/cumm/conv/main/Ampere_s8s8s8s32f32tnt_m128n64k64m64n32k64A1T16832_300_C301LLL_SK_S8/mma/mma_ns_wa/ldsm/LdMatrix.h>
namespace spconvlib {
namespace cumm {
namespace conv {
namespace main {
...
namespace mma {
namespace mma_ns_wa {
using TensorOpLayout = spconvlib::cumm::conv::main::Ampere_s8s8s8s32f32tnt_m128n64k64m64n32k64A1T16832_300_C301LLL_SK_S8::mma::mma_ns_wa::layout::MyTensorOpLayout;
using LdMatrix = spconvlib::cumm::conv::main::Ampere_s8s8s8s32f32tnt_m128n64k64m64n32k64A1T16832_300_C301LLL_SK_S8::mma::mma_ns_wa::ldsm::LdMatrix;
