...
#include <spconvlib/cumm/conv/main/Turing_s8s8s8s32f32tnt_m32n64k32m32n32k32A1T8816_200_C301LLL_SK_S8/inpiterb/gload/GlobalLoad.h>
#include <spconvlib/cumm/conv/main/Turing_s8s8s8s32f32tnt_m32n64k32m32n32k32A1T8816_200_C301LLL_SK_S8/inpiterb/tmap/PitchLinearWarpRaked.h>
...
using GlobalLoad = spconvlib::cumm::conv::main::Turing_s8s8s8s32f32tnt_m32n64k32m32n32k32A1T8816_200_C301LLL_SK_S8::inpiterb::gload::GlobalLoad;
using ThreadMap = spconvlib::cumm::conv::main::Turing_s8s8s8s32f32tnt_m32n64k32m32n32k32A1T8816_200_C301LLL_SK_S8::inpiterb::tmap::PitchLinearWarpRaked;
...
using Params = spconvlib::cumm::conv::main::cpTuring_s8s8s8s32f32tnt_m32n64k32m32n32k32A1T8816_200_C301LLL_SK_S8::iterb_p::WeightOptParams;
using Layout = spconvlib::cumm::conv::main::cpTuring_s8s8s8s32f32tnt_m32n64k32m32n32k32A1T8816_200_C301LLL_SK_S8::lb::TensorGeneric;
