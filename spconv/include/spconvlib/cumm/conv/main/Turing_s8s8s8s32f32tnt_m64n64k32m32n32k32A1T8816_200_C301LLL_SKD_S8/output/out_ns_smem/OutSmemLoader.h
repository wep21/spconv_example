...
#include <spconvlib/cumm/conv/main/Turing_s8s8s8s32f32tnt_m64n64k32m32n32k32A1T8816_200_C301LLL_SKD_S8/output/out_ns_smem/tmap/Out5DLinear.h>
namespace spconvlib {
namespace cumm {
namespace conv {
namespace main {
...
using ThreadMap = spconvlib::cumm::conv::main::Turing_s8s8s8s32f32tnt_m64n64k32m32n32k32A1T8816_200_C301LLL_SKD_S8::output::out_ns_smem::tmap::Out5DLinear;
