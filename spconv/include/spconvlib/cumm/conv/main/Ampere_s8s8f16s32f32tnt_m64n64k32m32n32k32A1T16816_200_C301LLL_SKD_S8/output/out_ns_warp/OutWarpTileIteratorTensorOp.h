...
struct OutWarpTileIteratorTensorOp {
  ...
  RowMajor layout_;
  __forceinline__ __device__  OutWarpTileIteratorTensorOp(int32_t * ptr, int warp_offset_m, int warp_offset_n, int lane_idx) : pointer_(reinterpret_cast<tv::alignedarray<int2, 1, 8> *>(ptr)), layout_(36)  {
