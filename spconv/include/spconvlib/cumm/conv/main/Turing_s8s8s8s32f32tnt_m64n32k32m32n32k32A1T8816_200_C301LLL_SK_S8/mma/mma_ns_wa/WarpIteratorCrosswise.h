...
#include <spconvlib/cumm/conv/main/Turing_s8s8s8s32f32tnt_m64n32k32m32n32k32A1T8816_200_C301LLL_SK_S8/mma/mma_ns_wa/ldsm/LdMatrix.h>
namespace spconvlib {
namespace cumm {
namespace conv {
namespace main {
...
namespace mma {
namespace mma_ns_wa {
using TensorOpLayout = spconvlib::cumm::conv::main::Turing_s8s8s8s32f32tnt_m64n32k32m32n32k32A1T8816_200_C301LLL_SK_S8::mma::mma_ns_wa::layout::MyTensorOpLayout;
using LdMatrix = spconvlib::cumm::conv::main::Turing_s8s8s8s32f32tnt_m64n32k32m32n32k32A1T8816_200_C301LLL_SK_S8::mma::mma_ns_wa::ldsm::LdMatrix;
