...
#include <spconvlib/cumm/conv/main/Ampere_s8s8s8s32f16tnt_m128n128k128m64n64k128A1T16832_300_C301LLL_SKD_S8/inpiterb/gload/GlobalLoad.h>
#include <spconvlib/cumm/conv/main/Ampere_s8s8s8s32f16tnt_m128n128k128m64n64k128A1T16832_300_C301LLL_SKD_S8/inpiterb/tmap/PitchLinearWarpRaked.h>
...
using GlobalLoad = spconvlib::cumm::conv::main::Ampere_s8s8s8s32f16tnt_m128n128k128m64n64k128A1T16832_300_C301LLL_SKD_S8::inpiterb::gload::GlobalLoad;
using ThreadMap = spconvlib::cumm::conv::main::Ampere_s8s8s8s32f16tnt_m128n128k128m64n64k128A1T16832_300_C301LLL_SKD_S8::inpiterb::tmap::PitchLinearWarpRaked;
...
using Params = spconvlib::cumm::conv::main::cpAmpere_s8s8s8s32f16tnt_m128n128k128m64n64k128A1T16832_300_C301LLL_SKD_S8::iterb_p::WeightOptParams;
using Layout = spconvlib::cumm::conv::main::cpAmpere_s8s8s8s32f16tnt_m128n128k128m64n64k128A1T16832_300_C301LLL_SKD_S8::lb::TensorGeneric;
struct WeightIteratorDP4A {
  ...
  __forceinline__ __device__ const tv::array<int8_t, 16> * get(int stride, int contig, int ss)  const {
    ...
    return reinterpret_cast<const tv::array<int8_t, 16> *>(pointer_ + contig * 128 * 8 / 8);
  }
