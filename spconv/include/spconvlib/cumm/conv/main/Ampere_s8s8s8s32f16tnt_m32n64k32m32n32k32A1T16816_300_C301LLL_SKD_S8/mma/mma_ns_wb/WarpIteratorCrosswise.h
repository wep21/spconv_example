...
#include <spconvlib/cumm/conv/main/Ampere_s8s8s8s32f16tnt_m32n64k32m32n32k32A1T16816_300_C301LLL_SKD_S8/mma/mma_ns_wb/ldsm/LdMatrix.h>
namespace spconvlib {
namespace cumm {
namespace conv {
namespace main {
...
namespace mma {
namespace mma_ns_wb {
using TensorOpLayout = spconvlib::cumm::conv::main::Ampere_s8s8s8s32f16tnt_m32n64k32m32n32k32A1T16816_300_C301LLL_SKD_S8::mma::mma_ns_wb::layout::MyTensorOpLayout;
using LdMatrix = spconvlib::cumm::conv::main::Ampere_s8s8s8s32f16tnt_m32n64k32m32n32k32A1T16816_300_C301LLL_SKD_S8::mma::mma_ns_wb::ldsm::LdMatrix;
