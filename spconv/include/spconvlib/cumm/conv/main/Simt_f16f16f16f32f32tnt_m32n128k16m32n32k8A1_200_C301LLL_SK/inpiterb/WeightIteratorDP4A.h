...
#include <spconvlib/cumm/conv/main/Simt_f16f16f16f32f32tnt_m32n128k16m32n32k8A1_200_C301LLL_SK/inpiterb/gload/GlobalLoad.h>
#include <spconvlib/cumm/conv/main/Simt_f16f16f16f32f32tnt_m32n128k16m32n32k8A1_200_C301LLL_SK/inpiterb/tmap/PitchLinear.h>
...
using GlobalLoad = spconvlib::cumm::conv::main::Simt_f16f16f16f32f32tnt_m32n128k16m32n32k8A1_200_C301LLL_SK::inpiterb::gload::GlobalLoad;
using ThreadMap = spconvlib::cumm::conv::main::Simt_f16f16f16f32f32tnt_m32n128k16m32n32k8A1_200_C301LLL_SK::inpiterb::tmap::PitchLinear;
using ConvProblem = spconvlib::cumm::conv::main::cpSimt_f16f16f16f32f32tnt_m32n128k16m32n32k8A1_200_C301LLL_SK::cp::ConvProblem;
using Params = spconvlib::cumm::conv::main::cpSimt_f16f16f16f32f32tnt_m32n128k16m32n32k8A1_200_C301LLL_SK::iterb_p::WeightOptParams;
using Layout = spconvlib::cumm::conv::main::cpSimt_f16f16f16f32f32tnt_m32n128k16m32n32k8A1_200_C301LLL_SK::lb::TensorGeneric;
