...
#include <spconvlib/cumm/conv/main/Ampere_s8s8s8s32f32tnt_m256n128k64m128n64k64A1T16832_400_C301LLL_SKD_S8/inpiterb/gload/GlobalLoad.h>
#include <spconvlib/cumm/conv/main/Ampere_s8s8s8s32f32tnt_m256n128k64m128n64k64A1T16832_400_C301LLL_SKD_S8/inpiterb/tmap/PitchLinearWarpRaked.h>
...
using GlobalLoad = spconvlib::cumm::conv::main::Ampere_s8s8s8s32f32tnt_m256n128k64m128n64k64A1T16832_400_C301LLL_SKD_S8::inpiterb::gload::GlobalLoad;
using ThreadMap = spconvlib::cumm::conv::main::Ampere_s8s8s8s32f32tnt_m256n128k64m128n64k64A1T16832_400_C301LLL_SKD_S8::inpiterb::tmap::PitchLinearWarpRaked;
...
using Params = spconvlib::cumm::conv::main::cpAmpere_s8s8s8s32f32tnt_m256n128k64m128n64k64A1T16832_400_C301LLL_SKD_S8::iterb_p::WeightOptParams;
using Layout = spconvlib::cumm::conv::main::cpAmpere_s8s8s8s32f32tnt_m256n128k64m128n64k64A1T16832_400_C301LLL_SKD_S8::lb::TensorGeneric;
struct WeightIteratorDP4A {
  ...
  __forceinline__ __device__ void load_with_pointer_offset(tv::array<int8_t, 64, 0>& frag, int32_t pointer_offset)   {
  ...
  __forceinline__ __device__ void load(tv::array<int8_t, 64, 0>& frag)   {
