...
#include <spconvlib/cumm/conv/main/Turing_s8s8s8s32f32tnt_m64n128k64m32n64k64A1T8816_200_C301LLL_SK_S8/mma/mma_ns_wa/layout/MyTensorOpLayout.h>
namespace spconvlib {
namespace cumm {
namespace conv {
namespace main {
...
using Layout = spconvlib::cumm::conv::main::Turing_s8s8s8s32f32tnt_m64n128k64m32n64k64A1T8816_200_C301LLL_SK_S8::mma::mma_ns_wa::layout::MyTensorOpLayout;
