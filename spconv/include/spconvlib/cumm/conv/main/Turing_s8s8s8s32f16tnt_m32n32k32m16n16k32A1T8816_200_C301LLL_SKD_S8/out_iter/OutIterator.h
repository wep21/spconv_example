...
#include <spconvlib/cumm/conv/main/cpTuring_s8s8s8s32f16tnt_m32n32k32m16n16k32A1T8816_200_C301LLL_SKD_S8/out_params_ns/tmap/Out5DLinear.h>
...
using ThreadMap = spconvlib::cumm::conv::main::cpTuring_s8s8s8s32f16tnt_m32n32k32m16n16k32A1T8816_200_C301LLL_SKD_S8::out_params_ns::tmap::Out5DLinear;
using Params = spconvlib::cumm::conv::main::cpTuring_s8s8s8s32f16tnt_m32n32k32m16n16k32A1T8816_200_C301LLL_SKD_S8::out_params_ns::OutIteratorParams;
struct OutIterator {
  int8_t * pointer_;
        ...
        for (int row = 0; row < 1; ++row){
          ...
          for (int column = 0; column < 1; ++column){
            ...
            tv::gemm::global_store<tv::alignedarray<int, 1, 4>, sizeof(tv::alignedarray<int, 1, 4>)>(
                ...
                (void *)&memory_pointer[column * 32 / 4],
                guard);
          }
        }
      }
