...
#include <spconvlib/cumm/conv/main/cpTuring_s8s8s8s32f16tnt_m32n64k32m32n32k32A1T8816_200_C301LLL_SK_S8/out_params_ns/tmap/Out5DLinear.h>
...
using ThreadMap = spconvlib::cumm::conv::main::cpTuring_s8s8s8s32f16tnt_m32n64k32m32n32k32A1T8816_200_C301LLL_SK_S8::out_params_ns::tmap::Out5DLinear;
using Params = spconvlib::cumm::conv::main::cpTuring_s8s8s8s32f16tnt_m32n64k32m32n32k32A1T8816_200_C301LLL_SK_S8::out_params_ns::OutIteratorParams;
struct OutIterator {
  int8_t * pointer_;
