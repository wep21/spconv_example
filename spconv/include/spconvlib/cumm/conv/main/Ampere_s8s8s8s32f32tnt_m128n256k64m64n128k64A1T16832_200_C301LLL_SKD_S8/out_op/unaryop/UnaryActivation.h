...
struct UnaryActivation {
  __forceinline__ __device__ tv::array<float, 16, 0> operator()(const tv::array<float, 16, 0> & src, tv::gemm::Activation type, float alpha, float beta)   {
    
    namespace op = tv::arrayops;
    using scalar_nv_t = tv::equivalent_data_type_t<float>;
    auto& src_nv = reinterpret_cast<const tv::array<tv::equivalent_data_type_t<float>, 16, 0>&>(src);
