...
struct OutWarpTileIteratorTensorOp {
  ...
  RowMajor layout_;
  __forceinline__ __device__  OutWarpTileIteratorTensorOp(tv::half_t * ptr, int warp_offset_m, int warp_offset_n, int lane_idx) : pointer_(reinterpret_cast<tv::alignedarray<int, 1, 4> *>(ptr)), layout_(20)  {
