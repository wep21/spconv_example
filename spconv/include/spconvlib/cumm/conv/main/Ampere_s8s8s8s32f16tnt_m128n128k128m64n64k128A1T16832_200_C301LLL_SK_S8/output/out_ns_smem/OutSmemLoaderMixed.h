...
#include <spconvlib/cumm/conv/main/Ampere_s8s8s8s32f16tnt_m128n128k128m64n64k128A1T16832_200_C301LLL_SK_S8/output/out_ns_smem/tmap/Out5DLinear.h>
namespace spconvlib {
namespace cumm {
namespace conv {
namespace main {
...
using ThreadMap = spconvlib::cumm::conv::main::Ampere_s8s8s8s32f16tnt_m128n128k128m64n64k128A1T16832_200_C301LLL_SK_S8::output::out_ns_smem::tmap::Out5DLinear;
