...
#include <spconvlib/cumm/conv/main/Ampere_s8s8s8s32f32tnt_m64n128k64m32n64k64A1T16832_300_C301LLL_SKD_S8/mma/mma_ns_wa/layout/MyTensorOpLayout.h>
namespace spconvlib {
namespace cumm {
namespace conv {
namespace main {
...
using Layout = spconvlib::cumm::conv::main::Ampere_s8s8s8s32f32tnt_m64n128k64m32n64k64A1T16832_300_C301LLL_SKD_S8::mma::mma_ns_wa::layout::MyTensorOpLayout;
struct SmemTileIterator {
  ...
  __forceinline__ __device__ void store_with_pointer_offset(tv::array<int8_t, 32, 0> const& frag, int32_t pointer_offset)   {
    store_with_byte_offset(frag, pointer_offset * 8 / 8);
  }
  __forceinline__ __device__ void store_with_byte_offset(tv::array<int8_t, 32, 0> const& frag, int32_t byte_offset)   {
