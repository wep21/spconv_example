...
#include <spconvlib/cumm/conv/main/Turing_s8s8s8s32f32tnt_m256n128k64m128n64k64A1T8816_200_C301LLL_SKD_S8/mma/mma_ns_wmma/tensorop/MmaSync.h>
namespace spconvlib {
namespace cumm {
namespace conv {
namespace main {
...
using InstMma = spconvlib::cumm::conv::main::Turing_s8s8s8s32f32tnt_m256n128k64m128n64k64A1T8816_200_C301LLL_SKD_S8::mma::mma_ns_wmma::tensorop::MmaSync;
