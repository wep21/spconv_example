...
#include <spconvlib/cumm/conv/main/Ampere_f32f32f32f32f32tnt_m64n64k32m32n32k32A1T1688_300_C301LLL_SK/inpitera/mask/Mask.h>
#include <spconvlib/cumm/conv/main/Ampere_f32f32f32f32f32tnt_m64n64k32m32n32k32A1T1688_300_C301LLL_SK/inpitera/gload/GlobalLoad.h>
#include <spconvlib/cumm/conv/main/Ampere_f32f32f32f32f32tnt_m64n64k32m32n32k32A1T1688_300_C301LLL_SK/inpitera/tmap/PitchLinearWarpRaked.h>
...
using Mask = spconvlib::cumm::conv::main::Ampere_f32f32f32f32f32tnt_m64n64k32m32n32k32A1T1688_300_C301LLL_SK::inpitera::mask::Mask;
using GlobalLoad = spconvlib::cumm::conv::main::Ampere_f32f32f32f32f32tnt_m64n64k32m32n32k32A1T1688_300_C301LLL_SK::inpitera::gload::GlobalLoad;
using ThreadMap = spconvlib::cumm::conv::main::Ampere_f32f32f32f32f32tnt_m64n64k32m32n32k32A1T1688_300_C301LLL_SK::inpitera::tmap::PitchLinearWarpRaked;
...
using Params = spconvlib::cumm::conv::main::cpAmpere_f32f32f32f32f32tnt_m64n64k32m32n32k32A1T1688_300_C301LLL_SK::itera_p::SparseParams;
struct ForwardDgradSparseIOIterator {
  ...
  __forceinline__ __device__  ForwardDgradSparseIOIterator(Params & params, ConvProblem const& problem_size, const float * ptr, int thread_id, const tv::array<int, 2>& threadblock_offset) : params_(params), problem_(problem_size), indice_ptr_(params.indice_ptr_)  {
    ...
    TV_PRAGMA_UNROLL
    for (int v = 0; v < 1; ++v){
        mask_[v] = thread_offset[1] + v * 4 >= problem_.C ? 0 : mask_[v];
    }
  ...
  __forceinline__ __device__ void increment_k()   {
    ...
    TV_PRAGMA_UNROLL
    for (int v = 0; v < 1; ++v){
        clear_mask_if_pred(reduce_channel_offset_ + v * 4 >= problem_.C, v);
    }
  }
