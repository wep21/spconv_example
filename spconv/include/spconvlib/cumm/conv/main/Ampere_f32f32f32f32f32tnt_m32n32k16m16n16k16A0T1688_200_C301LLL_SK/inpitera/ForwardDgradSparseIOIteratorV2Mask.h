...
#include <spconvlib/cumm/conv/main/Ampere_f32f32f32f32f32tnt_m32n32k16m16n16k16A0T1688_200_C301LLL_SK/inpitera/mask/Mask.h>
#include <spconvlib/cumm/conv/main/Ampere_f32f32f32f32f32tnt_m32n32k16m16n16k16A0T1688_200_C301LLL_SK/inpitera/gload/GlobalLoad.h>
#include <spconvlib/cumm/conv/main/Ampere_f32f32f32f32f32tnt_m32n32k16m16n16k16A0T1688_200_C301LLL_SK/inpitera/tmap/PitchLinearWarpRaked.h>
...
using Mask = spconvlib::cumm::conv::main::Ampere_f32f32f32f32f32tnt_m32n32k16m16n16k16A0T1688_200_C301LLL_SK::inpitera::mask::Mask;
using GlobalLoad = spconvlib::cumm::conv::main::Ampere_f32f32f32f32f32tnt_m32n32k16m16n16k16A0T1688_200_C301LLL_SK::inpitera::gload::GlobalLoad;
using ThreadMap = spconvlib::cumm::conv::main::Ampere_f32f32f32f32f32tnt_m32n32k16m16n16k16A0T1688_200_C301LLL_SK::inpitera::tmap::PitchLinearWarpRaked;
...
using Params = spconvlib::cumm::conv::main::cpAmpere_f32f32f32f32f32tnt_m32n32k16m16n16k16A0T1688_200_C301LLL_SK::itera_p::SparseParams;
struct ForwardDgradSparseIOIteratorV2Mask {
  ...
  Mask mask_;
  int32_t indices_[1];
  __forceinline__ __device__  ForwardDgradSparseIOIteratorV2Mask(Params & params, ConvProblem const& problem_size, const float * ptr, int thread_id, const tv::array<int, 2>& threadblock_offset) : params_(params), problem_(problem_size), indice_ptr_(params.indice_ptr_)  {
  ...
  __forceinline__ __device__ const tv::array<float, 1> * get(int indice_offset)  const {
    
    return reinterpret_cast<const tv::array<float, 1> *>( pointer_ + indice_offset);
  }
      ...
      for (int c = 0; c < 1; ++c){
        ...
        for (int ss = 0; ss < 1; ++ss){
          ...
          for (int v = 0; v < 4; ++v){
            ...
            auto access_pointer = reinterpret_cast<const tv::array<float, 1> *>(pointer_ + indice_offset + 
                c * 64) + v;
