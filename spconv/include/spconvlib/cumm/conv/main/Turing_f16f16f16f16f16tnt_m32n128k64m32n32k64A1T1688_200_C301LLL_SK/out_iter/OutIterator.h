...
#include <spconvlib/cumm/conv/main/cpTuring_f16f16f16f16f16tnt_m32n128k64m32n32k64A1T1688_200_C301LLL_SK/out_params_ns/tmap/Out5DLinear.h>
...
using ThreadMap = spconvlib::cumm::conv::main::cpTuring_f16f16f16f16f16tnt_m32n128k64m32n32k64A1T1688_200_C301LLL_SK::out_params_ns::tmap::Out5DLinear;
using Params = spconvlib::cumm::conv::main::cpTuring_f16f16f16f16f16tnt_m32n128k64m32n32k64A1T1688_200_C301LLL_SK::out_params_ns::OutIteratorParams;
struct OutIterator {
  tv::half_t * pointer_;
        ...
        for (int row = 0; row < 1; ++row){
          ...
          for (int column = 0; column < 1; ++column){
            ...
            tv::gemm::global_store<tv::alignedarray<int4, 1, 16>, sizeof(tv::alignedarray<int4, 1, 16>)>(
                ...
                (void *)&memory_pointer[column * 128 / 8],
                guard);
          }
        }
      }
        ...
        for (int row = 0; row < 1; ++row){
          ...
          for (int column = 0; column < 1; ++column){
            ...
            tv::gemm::global_load<tv::alignedarray<int4, 1, 16>, sizeof(tv::alignedarray<int4, 1, 16>)>(
                frag_ptr[frag_row_idx *  1 + column],
                (const void *)&memory_pointer[column * 128 / 8],
                guard);
          }
        }
      }
