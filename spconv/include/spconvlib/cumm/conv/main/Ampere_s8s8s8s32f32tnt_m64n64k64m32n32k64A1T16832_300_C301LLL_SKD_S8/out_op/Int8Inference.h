...
#include <spconvlib/cumm/conv/main/Ampere_s8s8s8s32f32tnt_m64n64k64m32n32k64A1T16832_300_C301LLL_SKD_S8/out_op/unaryop/UnaryActivation.h>
namespace spconvlib {
namespace cumm {
namespace conv {
namespace main {
...
namespace out_op {
using UnaryOp = spconvlib::cumm::conv::main::Ampere_s8s8s8s32f32tnt_m64n64k64m32n32k64A1T16832_300_C301LLL_SKD_S8::out_op::unaryop::UnaryActivation;
