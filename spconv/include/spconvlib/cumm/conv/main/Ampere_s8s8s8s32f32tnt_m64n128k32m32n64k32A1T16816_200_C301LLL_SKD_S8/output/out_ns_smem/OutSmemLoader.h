...
#include <spconvlib/cumm/conv/main/Ampere_s8s8s8s32f32tnt_m64n128k32m32n64k32A1T16816_200_C301LLL_SKD_S8/output/out_ns_smem/tmap/Out5DLinear.h>
namespace spconvlib {
namespace cumm {
namespace conv {
namespace main {
...
using ThreadMap = spconvlib::cumm::conv::main::Ampere_s8s8s8s32f32tnt_m64n128k32m32n64k32A1T16816_200_C301LLL_SKD_S8::output::out_ns_smem::tmap::Out5DLinear;
