...
#include <spconvlib/cumm/conv/main/Ampere_s8s8s8s32f16tnt_m64n64k32m32n32k32A1T16816_400_C301LLL_SKD_S8/mma/mma_ns_wmma/tensorop/MmaSync.h>
namespace spconvlib {
namespace cumm {
namespace conv {
namespace main {
...
using InstMma = spconvlib::cumm::conv::main::Ampere_s8s8s8s32f16tnt_m64n64k32m32n32k32A1T16816_400_C301LLL_SKD_S8::mma::mma_ns_wmma::tensorop::MmaSync;
