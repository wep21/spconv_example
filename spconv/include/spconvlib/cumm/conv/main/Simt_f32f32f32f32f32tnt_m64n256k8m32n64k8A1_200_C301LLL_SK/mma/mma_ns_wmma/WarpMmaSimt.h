...
#include <spconvlib/cumm/conv/main/Simt_f32f32f32f32f32tnt_m64n256k8m32n64k8A1_200_C301LLL_SK/mma/mma_ns_wmma/instmma/InstMma.h>
namespace spconvlib {
namespace cumm {
namespace conv {
namespace main {
...
using InstMma = spconvlib::cumm::conv::main::Simt_f32f32f32f32f32tnt_m64n256k8m32n64k8A1_200_C301LLL_SK::mma::mma_ns_wmma::instmma::InstMma;
struct WarpMmaSimt {
