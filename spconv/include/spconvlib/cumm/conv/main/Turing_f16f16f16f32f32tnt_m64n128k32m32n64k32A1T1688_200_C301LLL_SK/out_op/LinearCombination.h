...
#include <spconvlib/cumm/conv/main/Turing_f16f16f16f32f32tnt_m64n128k32m32n64k32A1T1688_200_C301LLL_SK/out_op/unaryop/UnaryActivation.h>
namespace spconvlib {
namespace cumm {
namespace conv {
namespace main {
...
namespace out_op {
using UnaryOp = spconvlib::cumm::conv::main::Turing_f16f16f16f32f32tnt_m64n128k32m32n64k32A1T1688_200_C301LLL_SK::out_op::unaryop::UnaryActivation;
struct LinearCombination {
  ...
  __forceinline__ __device__ tv::array<tv::half_t, 8, 0> operator()(tv::array<float, 8, 0> const& accumulator, tv::array<tv::half_t, 8, 0> const& source)  const {
    
    tv::gemm::NumericArrayConverter<float, tv::half_t, 8, tv::gemm::FloatRoundStyle::round_to_nearest>
        source_converter;
    tv::gemm::NumericArrayConverter<float, float, 8, tv::gemm::FloatRoundStyle::round_to_nearest>
    ...
    tv::math::multiplies<tv::array<float, 8, 0>> mul_add_source;
    ...
    tv::gemm::NumericArrayConverter<tv::half_t, float, 8, tv::gemm::FloatRoundStyle::round_to_nearest>
        destination_converter;
    return destination_converter(intermediate);
  }
  __forceinline__ __device__ tv::array<tv::half_t, 8, 0> operator()(tv::array<float, 8, 0> const& accumulator)  const {
    
    tv::gemm::NumericArrayConverter<float, float, 8, tv::gemm::FloatRoundStyle::round_to_nearest>
        accumulator_converter;
    tv::array<float, 8, 0> converted_accumulator = accumulator_converter(accumulator);
    tv::array<float, 8, 0> intermediate;
    tv::math::multiplies<tv::array<float, 8, 0>> mul_accumulator;
