...
#include <spconvlib/cumm/conv/main/Turing_f16f16f16f16f16tnt_m32n16k16m16n16k16A1T1688_200_C301LLL_SK/inpiterb/gload/GlobalLoad.h>
#include <spconvlib/cumm/conv/main/Turing_f16f16f16f16f16tnt_m32n16k16m16n16k16A1T1688_200_C301LLL_SK/inpiterb/tmap/PitchLinearWarpRaked.h>
...
using GlobalLoad = spconvlib::cumm::conv::main::Turing_f16f16f16f16f16tnt_m32n16k16m16n16k16A1T1688_200_C301LLL_SK::inpiterb::gload::GlobalLoad;
using ThreadMap = spconvlib::cumm::conv::main::Turing_f16f16f16f16f16tnt_m32n16k16m16n16k16A1T1688_200_C301LLL_SK::inpiterb::tmap::PitchLinearWarpRaked;
...
using Params = spconvlib::cumm::conv::main::cpTuring_f16f16f16f16f16tnt_m32n16k16m16n16k16A1T1688_200_C301LLL_SK::iterb_p::WeightOptParams;
using Layout = spconvlib::cumm::conv::main::cpTuring_f16f16f16f16f16tnt_m32n16k16m16n16k16A1T1688_200_C301LLL_SK::lb::TensorGeneric;
struct WeightIteratorDP4A {
  ...
  __forceinline__ __device__ const tv::array<tv::half_t, 8> * get(int stride, int contig, int ss)  const {
    ...
    return reinterpret_cast<const tv::array<tv::half_t, 8> *>(pointer_ + contig * 16 * 16 / 8);
  }
