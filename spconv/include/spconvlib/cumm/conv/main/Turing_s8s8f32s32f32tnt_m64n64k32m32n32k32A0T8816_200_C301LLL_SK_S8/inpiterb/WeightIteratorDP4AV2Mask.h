...
#include <spconvlib/cumm/conv/main/Turing_s8s8f32s32f32tnt_m64n64k32m32n32k32A0T8816_200_C301LLL_SK_S8/inpiterb/gload/GlobalLoad.h>
#include <spconvlib/cumm/conv/main/Turing_s8s8f32s32f32tnt_m64n64k32m32n32k32A0T8816_200_C301LLL_SK_S8/inpiterb/mask/Mask.h>
#include <spconvlib/cumm/conv/main/Turing_s8s8f32s32f32tnt_m64n64k32m32n32k32A0T8816_200_C301LLL_SK_S8/inpiterb/tmap/PitchLinearWarpRaked.h>
...
using GlobalLoad = spconvlib::cumm::conv::main::Turing_s8s8f32s32f32tnt_m64n64k32m32n32k32A0T8816_200_C301LLL_SK_S8::inpiterb::gload::GlobalLoad;
using Mask = spconvlib::cumm::conv::main::Turing_s8s8f32s32f32tnt_m64n64k32m32n32k32A0T8816_200_C301LLL_SK_S8::inpiterb::mask::Mask;
using ThreadMap = spconvlib::cumm::conv::main::Turing_s8s8f32s32f32tnt_m64n64k32m32n32k32A0T8816_200_C301LLL_SK_S8::inpiterb::tmap::PitchLinearWarpRaked;
...
using Params = spconvlib::cumm::conv::main::cpTuring_s8s8f32s32f32tnt_m64n64k32m32n32k32A0T8816_200_C301LLL_SK_S8::iterb_p::WeightOptParams;
using Layout = spconvlib::cumm::conv::main::cpTuring_s8s8f32s32f32tnt_m64n64k32m32n32k32A0T8816_200_C301LLL_SK_S8::lb::TensorGeneric;
