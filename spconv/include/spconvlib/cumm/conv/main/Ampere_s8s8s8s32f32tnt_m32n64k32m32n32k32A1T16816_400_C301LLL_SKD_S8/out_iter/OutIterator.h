...
#include <spconvlib/cumm/conv/main/cpAmpere_s8s8s8s32f32tnt_m32n64k32m32n32k32A1T16816_400_C301LLL_SKD_S8/out_params_ns/tmap/Out5DLinear.h>
...
using ThreadMap = spconvlib::cumm::conv::main::cpAmpere_s8s8s8s32f32tnt_m32n64k32m32n32k32A1T16816_400_C301LLL_SKD_S8::out_params_ns::tmap::Out5DLinear;
using Params = spconvlib::cumm::conv::main::cpAmpere_s8s8s8s32f32tnt_m32n64k32m32n32k32A1T16816_400_C301LLL_SKD_S8::out_params_ns::OutIteratorParams;
struct OutIterator {
  int8_t * pointer_;
