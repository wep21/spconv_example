...
#include <spconvlib/cumm/conv/main/Ampere_s8s8s8s32f16tnt_m64n64k64m32n32k64A1T16832_400_C301LLL_SKD_S8/mma/mma_ns_wb/layout/MyTensorOpLayout.h>
namespace spconvlib {
namespace cumm {
namespace conv {
namespace main {
...
using Layout = spconvlib::cumm::conv::main::Ampere_s8s8s8s32f16tnt_m64n64k64m32n32k64A1T16832_400_C301LLL_SKD_S8::mma::mma_ns_wb::layout::MyTensorOpLayout;
