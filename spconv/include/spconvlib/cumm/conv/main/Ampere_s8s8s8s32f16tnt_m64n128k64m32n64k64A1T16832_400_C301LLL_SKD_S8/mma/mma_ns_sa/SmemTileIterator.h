...
#include <spconvlib/cumm/conv/main/Ampere_s8s8s8s32f16tnt_m64n128k64m32n64k64A1T16832_400_C301LLL_SKD_S8/mma/mma_ns_wa/layout/MyTensorOpLayout.h>
namespace spconvlib {
namespace cumm {
namespace conv {
namespace main {
...
using Layout = spconvlib::cumm::conv::main::Ampere_s8s8s8s32f16tnt_m64n128k64m32n64k64A1T16832_400_C301LLL_SKD_S8::mma::mma_ns_wa::layout::MyTensorOpLayout;
