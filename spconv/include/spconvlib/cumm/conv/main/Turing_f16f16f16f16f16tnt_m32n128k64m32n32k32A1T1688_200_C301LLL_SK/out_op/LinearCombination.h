...
#include <spconvlib/cumm/conv/main/Turing_f16f16f16f16f16tnt_m32n128k64m32n32k32A1T1688_200_C301LLL_SK/out_op/unaryop/UnaryActivation.h>
namespace spconvlib {
namespace cumm {
namespace conv {
namespace main {
...
namespace out_op {
using UnaryOp = spconvlib::cumm::conv::main::Turing_f16f16f16f16f16tnt_m32n128k64m32n32k32A1T1688_200_C301LLL_SK::out_op::unaryop::UnaryActivation;
struct LinearCombination {
  ...
  __forceinline__ __device__ tv::array<tv::half_t, 4, 0> operator()(tv::array<tv::half_t, 4, 0> const& accumulator, tv::array<tv::half_t, 4, 0> const& source)  const {
    
    tv::gemm::NumericArrayConverter<tv::half_t, tv::half_t, 4, tv::gemm::FloatRoundStyle::round_to_nearest>
        source_converter;
    tv::gemm::NumericArrayConverter<tv::half_t, tv::half_t, 4, tv::gemm::FloatRoundStyle::round_to_nearest>
    ...
    tv::math::multiplies<tv::array<tv::half_t, 4, 0>> mul_add_source;
  ...
  __forceinline__ __device__ tv::array<tv::half_t, 4, 0> operator()(tv::array<tv::half_t, 4, 0> const& accumulator)  const {
    
    tv::gemm::NumericArrayConverter<tv::half_t, tv::half_t, 4, tv::gemm::FloatRoundStyle::round_to_nearest>
        accumulator_converter;
    tv::array<tv::half_t, 4, 0> converted_accumulator = accumulator_converter(accumulator);
    tv::array<tv::half_t, 4, 0> intermediate;
    tv::math::multiplies<tv::array<tv::half_t, 4, 0>> mul_accumulator;
