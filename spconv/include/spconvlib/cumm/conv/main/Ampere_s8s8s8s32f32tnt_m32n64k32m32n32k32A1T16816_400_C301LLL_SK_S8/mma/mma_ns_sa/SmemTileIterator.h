...
#include <spconvlib/cumm/conv/main/Ampere_s8s8s8s32f32tnt_m32n64k32m32n32k32A1T16816_400_C301LLL_SK_S8/mma/mma_ns_wa/layout/MyTensorOpLayout.h>
namespace spconvlib {
namespace cumm {
namespace conv {
namespace main {
...
using Layout = spconvlib::cumm::conv::main::Ampere_s8s8s8s32f32tnt_m32n64k32m32n32k32A1T16816_400_C301LLL_SK_S8::mma::mma_ns_wa::layout::MyTensorOpLayout;
