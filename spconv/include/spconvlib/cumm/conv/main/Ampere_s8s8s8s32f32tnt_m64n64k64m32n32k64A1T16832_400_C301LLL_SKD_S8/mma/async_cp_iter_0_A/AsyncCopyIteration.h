#pragma once
#include <spconvlib/cumm/conv/main/Ampere_s8s8s8s32f32tnt_m64n64k64m32n32k64A1T16832_400_C301LLL_SKD_S8/mma/async_cp_iter_0_A/cp_async_copy/CpAsyncCopy.h>
namespace spconvlib {
namespace cumm {
namespace conv {
namespace main {
...
using CpAsyncCp = spconvlib::cumm::conv::main::Ampere_s8s8s8s32f32tnt_m64n64k64m32n32k64A1T16832_400_C301LLL_SKD_S8::mma::async_cp_iter_0_A::cp_async_copy::CpAsyncCopy;
