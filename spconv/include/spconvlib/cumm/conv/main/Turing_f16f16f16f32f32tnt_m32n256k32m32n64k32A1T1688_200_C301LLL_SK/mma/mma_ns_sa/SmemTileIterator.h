...
#include <spconvlib/cumm/conv/main/Turing_f16f16f16f32f32tnt_m32n256k32m32n64k32A1T1688_200_C301LLL_SK/mma/mma_ns_wa/layout/MyTensorOpLayout.h>
namespace spconvlib {
namespace cumm {
namespace conv {
namespace main {
...
using Layout = spconvlib::cumm::conv::main::Turing_f16f16f16f32f32tnt_m32n256k32m32n64k32A1T1688_200_C301LLL_SK::mma::mma_ns_wa::layout::MyTensorOpLayout;
struct SmemTileIterator {
  ...
  __forceinline__ __device__ void store_with_byte_offset(tv::array<tv::half_t, 8, 0> const& frag, int32_t byte_offset)   {
