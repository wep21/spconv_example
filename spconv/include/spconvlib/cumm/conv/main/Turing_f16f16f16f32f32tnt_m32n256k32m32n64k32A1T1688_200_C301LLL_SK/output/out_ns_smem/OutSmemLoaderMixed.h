...
#include <spconvlib/cumm/conv/main/Turing_f16f16f16f32f32tnt_m32n256k32m32n64k32A1T1688_200_C301LLL_SK/output/out_ns_smem/tmap/Out5DLinear.h>
namespace spconvlib {
namespace cumm {
namespace conv {
namespace main {
...
using ThreadMap = spconvlib::cumm::conv::main::Turing_f16f16f16f32f32tnt_m32n256k32m32n64k32A1T1688_200_C301LLL_SK::output::out_ns_smem::tmap::Out5DLinear;
struct OutSmemLoaderMixed {
  ...
  __forceinline__ __device__  OutSmemLoaderMixed(float * ptr, int thread_idx)   {
    ...
    for (int i = 0; i < 2; ++i){
      ...
      // tv::printf2_once<' ', -1>(i, threadIdx.x, "col_idx_in_subacc", thread_offset[0], thread_offset[1], col_idx_in_subacc, thread_offset[0] * 66 + col_idx_in_subacc);
      pointers_[i] = pointer + thread_offset[0] * 66 + col_idx_in_subacc;
    }
  }
