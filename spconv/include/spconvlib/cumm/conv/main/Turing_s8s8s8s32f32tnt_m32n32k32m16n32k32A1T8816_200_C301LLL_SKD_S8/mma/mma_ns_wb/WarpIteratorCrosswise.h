...
#include <spconvlib/cumm/conv/main/Turing_s8s8s8s32f32tnt_m32n32k32m16n32k32A1T8816_200_C301LLL_SKD_S8/mma/mma_ns_wb/ldsm/LdMatrix.h>
namespace spconvlib {
namespace cumm {
namespace conv {
namespace main {
...
namespace mma {
namespace mma_ns_wb {
using TensorOpLayout = spconvlib::cumm::conv::main::Turing_s8s8s8s32f32tnt_m32n32k32m16n32k32A1T8816_200_C301LLL_SKD_S8::mma::mma_ns_wb::layout::MyTensorOpLayout;
using LdMatrix = spconvlib::cumm::conv::main::Turing_s8s8s8s32f32tnt_m32n32k32m16n32k32A1T8816_200_C301LLL_SKD_S8::mma::mma_ns_wb::ldsm::LdMatrix;
