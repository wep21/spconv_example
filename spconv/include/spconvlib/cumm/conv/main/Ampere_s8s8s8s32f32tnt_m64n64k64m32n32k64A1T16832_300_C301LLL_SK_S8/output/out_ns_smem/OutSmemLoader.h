...
#include <spconvlib/cumm/conv/main/Ampere_s8s8s8s32f32tnt_m64n64k64m32n32k64A1T16832_300_C301LLL_SK_S8/output/out_ns_smem/tmap/Out5DLinear.h>
namespace spconvlib {
namespace cumm {
namespace conv {
namespace main {
...
using ThreadMap = spconvlib::cumm::conv::main::Ampere_s8s8s8s32f32tnt_m64n64k64m32n32k64A1T16832_300_C301LLL_SK_S8::output::out_ns_smem::tmap::Out5DLinear;
