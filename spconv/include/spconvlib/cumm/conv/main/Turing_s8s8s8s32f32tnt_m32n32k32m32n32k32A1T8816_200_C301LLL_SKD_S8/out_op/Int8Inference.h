...
#include <spconvlib/cumm/conv/main/Turing_s8s8s8s32f32tnt_m32n32k32m32n32k32A1T8816_200_C301LLL_SKD_S8/out_op/unaryop/UnaryActivation.h>
namespace spconvlib {
namespace cumm {
namespace conv {
namespace main {
...
namespace out_op {
using UnaryOp = spconvlib::cumm::conv::main::Turing_s8s8s8s32f32tnt_m32n32k32m32n32k32A1T8816_200_C301LLL_SKD_S8::out_op::unaryop::UnaryActivation;
