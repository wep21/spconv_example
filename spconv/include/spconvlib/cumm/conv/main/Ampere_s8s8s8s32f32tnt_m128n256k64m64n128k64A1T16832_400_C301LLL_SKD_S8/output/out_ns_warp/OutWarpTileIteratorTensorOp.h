...
struct OutWarpTileIteratorTensorOp {
  ...
  RowMajor layout_;
  __forceinline__ __device__  OutWarpTileIteratorTensorOp(int32_t * ptr, int warp_offset_m, int warp_offset_n, int lane_idx) : pointer_(reinterpret_cast<tv::alignedarray<int2, 1, 8> *>(ptr)), layout_(132)  {
  ...
  __forceinline__ __device__ void store_with_pointer_offset(tv::array<int32_t, 32, 0> const & frag, int32_t pointer_offset)   {
  ...
  __forceinline__ __device__ void store(tv::array<int32_t, 32, 0> const& frag)   {
