...
using Params = spconvlib::cumm::conv::main::cpAmpere_s8s8s8s32f32tnt_m32n32k32m32n32k32A1T16816_400_C301LLL_SKD_S8::out_params_scalebias_ns::OutIteratorParams;
struct OutIterator {
