#pragma once
#include <spconvlib/cumm/conv/main/Ampere_s8s8s8s32f32tnt_m64n128k64m32n64k64A1T16832_200_C301LLL_SK_S8/mma/async_cp_iter_0_B/cp_async_copy/CpAsyncCopy.h>
namespace spconvlib {
namespace cumm {
namespace conv {
namespace main {
...
using CpAsyncCp = spconvlib::cumm::conv::main::Ampere_s8s8s8s32f32tnt_m64n128k64m32n64k64A1T16832_200_C301LLL_SK_S8::mma::async_cp_iter_0_B::cp_async_copy::CpAsyncCopy;
