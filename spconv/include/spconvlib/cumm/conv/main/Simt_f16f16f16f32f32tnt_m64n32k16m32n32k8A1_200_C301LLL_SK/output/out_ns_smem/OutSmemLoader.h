...
#include <spconvlib/cumm/conv/main/Simt_f16f16f16f32f32tnt_m64n32k16m32n32k8A1_200_C301LLL_SK/output/out_ns_smem/tmap/Out5DLinear.h>
namespace spconvlib {
namespace cumm {
namespace conv {
namespace main {
...
using ThreadMap = spconvlib::cumm::conv::main::Simt_f16f16f16f32f32tnt_m64n32k16m32n32k8A1_200_C301LLL_SK::output::out_ns_smem::tmap::Out5DLinear;
