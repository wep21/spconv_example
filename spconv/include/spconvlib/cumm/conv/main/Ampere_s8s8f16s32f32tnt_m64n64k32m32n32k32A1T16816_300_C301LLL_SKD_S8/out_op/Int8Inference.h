...
#include <spconvlib/cumm/conv/main/Ampere_s8s8f16s32f32tnt_m64n64k32m32n32k32A1T16816_300_C301LLL_SKD_S8/out_op/unaryop/UnaryActivation.h>
namespace spconvlib {
namespace cumm {
namespace conv {
namespace main {
...
namespace out_op {
using UnaryOp = spconvlib::cumm::conv::main::Ampere_s8s8f16s32f32tnt_m64n64k32m32n32k32A1T16816_300_C301LLL_SKD_S8::out_op::unaryop::UnaryActivation;
struct Int8Inference {
  ...
  __forceinline__ __device__ tv::array<tv::half_t, 8, 0> operator()(tv::array<int32_t, 8, 0> const& accumulator, tv::array<tv::half_t, 8, 0> const& source, tv::array<float, 8, 0> const& bias, tv::array<float, 8, 0> const& scale)  const {
  ...
  __forceinline__ __device__ tv::array<tv::half_t, 8, 0> operator()(tv::array<int32_t, 8, 0> const& accumulator, tv::array<float, 8, 0> const& bias, tv::array<float, 8, 0> const& scale)  const {
