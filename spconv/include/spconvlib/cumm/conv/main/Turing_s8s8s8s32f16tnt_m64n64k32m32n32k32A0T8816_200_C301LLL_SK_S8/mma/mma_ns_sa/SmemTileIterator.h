...
#include <spconvlib/cumm/conv/main/Turing_s8s8s8s32f16tnt_m64n64k32m32n32k32A0T8816_200_C301LLL_SK_S8/mma/mma_ns_wa/layout/MyTensorOpLayout.h>
namespace spconvlib {
namespace cumm {
namespace conv {
namespace main {
...
using Layout = spconvlib::cumm::conv::main::Turing_s8s8s8s32f16tnt_m64n64k32m32n32k32A0T8816_200_C301LLL_SK_S8::mma::mma_ns_wa::layout::MyTensorOpLayout;
