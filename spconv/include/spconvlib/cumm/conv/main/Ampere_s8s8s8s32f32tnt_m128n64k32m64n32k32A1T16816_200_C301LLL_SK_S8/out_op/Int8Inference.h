...
#include <spconvlib/cumm/conv/main/Ampere_s8s8s8s32f32tnt_m128n64k32m64n32k32A1T16816_200_C301LLL_SK_S8/out_op/unaryop/UnaryActivation.h>
namespace spconvlib {
namespace cumm {
namespace conv {
namespace main {
...
namespace out_op {
using UnaryOp = spconvlib::cumm::conv::main::Ampere_s8s8s8s32f32tnt_m128n64k32m64n32k32A1T16816_200_C301LLL_SK_S8::out_op::unaryop::UnaryActivation;
