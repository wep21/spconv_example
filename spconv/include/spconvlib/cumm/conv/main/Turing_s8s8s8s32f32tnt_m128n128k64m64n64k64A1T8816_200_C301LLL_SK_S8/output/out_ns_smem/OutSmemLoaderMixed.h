...
#include <spconvlib/cumm/conv/main/Turing_s8s8s8s32f32tnt_m128n128k64m64n64k64A1T8816_200_C301LLL_SK_S8/output/out_ns_smem/tmap/Out5DLinear.h>
namespace spconvlib {
namespace cumm {
namespace conv {
namespace main {
...
using ThreadMap = spconvlib::cumm::conv::main::Turing_s8s8s8s32f32tnt_m128n128k64m64n64k64A1T8816_200_C301LLL_SK_S8::output::out_ns_smem::tmap::Out5DLinear;
