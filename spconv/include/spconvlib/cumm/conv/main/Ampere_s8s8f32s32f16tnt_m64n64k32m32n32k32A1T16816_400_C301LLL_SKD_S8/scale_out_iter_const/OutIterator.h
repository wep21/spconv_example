...
using Params = spconvlib::cumm::conv::main::cpAmpere_s8s8f32s32f16tnt_m64n64k32m32n32k32A1T16816_400_C301LLL_SKD_S8::out_params_scalebias_ns::OutIteratorParams;
struct OutIterator {
      ...
      for (int group = 0; group < 1; ++group){
        ...
        for (int row = 0; row < 1; ++row){
          ...
          tv::alignedarray<int2, 1, 8> const *memory_pointer =
              reinterpret_cast<tv::alignedarray<int2, 1, 8> const *>(cur_pointer + offset);
          TV_PRAGMA_UNROLL
