...
#include <spconvlib/cumm/conv/main/Ampere_f16f16f16f16f16tnt_m64n64k32m32n32k32A1T1688_400_C301LLL_SK/out_op/unaryop/UnaryActivation.h>
namespace spconvlib {
namespace cumm {
namespace conv {
namespace main {
...
namespace out_op {
using UnaryOp = spconvlib::cumm::conv::main::Ampere_f16f16f16f16f16tnt_m64n64k32m32n32k32A1T1688_400_C301LLL_SK::out_op::unaryop::UnaryActivation;
