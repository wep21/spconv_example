...
__global__ void build_hash_table(TTable table, float const* points, int64_t * points_indice_data, int point_stride, tv::array<float, 3> vsize, tv::array<float, 6> coors_range, tv::array<int, 3> grid_bound, tv::array<int64_t, 3> grid_stride, int num_points)   {
...
template <typename TTable>
__global__ void generate_voxel(TTable table, float const* points, const int64_t* points_indice_data, float * voxels, int * num_per_voxel, int64_t* points_voxel_id, int point_stride, int max_points_per_voxel, int max_voxels, tv::array<float, 3> vsize, tv::array<float, 6> coors_range, tv::array<int, 3> grid_bound, tv::array<int64_t, 3> grid_stride, int num_points)   {
