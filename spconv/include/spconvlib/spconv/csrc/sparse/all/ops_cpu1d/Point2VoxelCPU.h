...
#include <spconvlib/spconv/csrc/sparse/all/ops_cpu1d/layout_ns/TensorGeneric.h>
...
struct Point2VoxelCPU {
   ...
   */
   Point2VoxelCPU(std::array<float, 1> vsize_xyz, std::array<float, 2> coors_range_xyz, int num_point_features, int max_num_voxels, int max_num_points_per_voxel);
   ...
   * @param clear_voxels 
   */
  static std::tuple<tv::Tensor, tv::Tensor, tv::Tensor> point_to_voxel_static(tv::Tensor points, tv::Tensor voxels, tv::Tensor indices, tv::Tensor num_per_voxel, tv::Tensor densehashdata, tv::Tensor points_voxel_id, std::array<float, 1> vsize, std::array<int, 1> grid_size, std::array<int, 1> grid_stride, std::array<float, 2> coors_range, bool clear_voxels = true);
  /**
   * @param points 
   * @param voxels 
   * @param indices 
