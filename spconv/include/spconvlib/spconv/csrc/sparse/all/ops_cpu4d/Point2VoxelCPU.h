...
#include <spconvlib/spconv/csrc/sparse/all/ops_cpu4d/layout_ns/TensorGeneric.h>
#include <spconvlib/spconv/csrc/sparse/all/ops_cpu4d/p2v_c/Point2VoxelCommon.h>
namespace spconvlib {
namespace spconv {
namespace csrc {
namespace sparse {
...
struct Point2VoxelCPU {
  ...
  tv::array<float, 4> vsize;
  tv::array<float, 8> coors_range;
  tv::array<int, 4> grid_size;
  tv::array<int, 4> grid_stride;
  
  std::array<int, 4> get_grid_size();
  /**
   * @param vsize_xyz 
   ...
   */
   Point2VoxelCPU(std::array<float, 4> vsize_xyz, std::array<float, 8> coors_range_xyz, int num_point_features, int max_num_voxels, int max_num_points_per_voxel);
   ...
   * @param clear_voxels 
   */
  static std::tuple<tv::Tensor, tv::Tensor, tv::Tensor> point_to_voxel_static(tv::Tensor points, tv::Tensor voxels, tv::Tensor indices, tv::Tensor num_per_voxel, tv::Tensor densehashdata, tv::Tensor points_voxel_id, std::array<float, 4> vsize, std::array<int, 4> grid_size, std::array<int, 4> grid_stride, std::array<float, 8> coors_range, bool clear_voxels = true);
  /**
   * @param points 
   * @param voxels 
   * @param indices 
