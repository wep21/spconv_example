...
#include <spconvlib/spconv/csrc/sparse/all/ops_cpu4d/spinds64/lociter/TensorGeneric.h>
#include <spconvlib/spconv/csrc/sparse/all/ops_cpu4d/spinds64/lociter_rs/TensorGeneric.h>
namespace spconvlib {
namespace spconv {
namespace csrc {
namespace sparse {
...
using LayoutNPQ = spconvlib::spconv::csrc::sparse::all::ops_cpu4d::spinds64::lociter::TensorGeneric;
using LayoutRS = spconvlib::spconv::csrc::sparse::all::ops_cpu4d::spinds64::lociter_rs::TensorGeneric;
