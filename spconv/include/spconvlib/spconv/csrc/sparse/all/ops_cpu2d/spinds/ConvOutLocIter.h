...
#include <spconvlib/spconv/csrc/sparse/all/ops_cpu2d/spinds/lociter/TensorGeneric.h>
#include <spconvlib/spconv/csrc/sparse/all/ops_cpu2d/spinds/lociter_rs/TensorGeneric.h>
namespace spconvlib {
namespace spconv {
namespace csrc {
namespace sparse {
...
using LayoutNPQ = spconvlib::spconv::csrc::sparse::all::ops_cpu2d::spinds::lociter::TensorGeneric;
using LayoutRS = spconvlib::spconv::csrc::sparse::all::ops_cpu2d::spinds::lociter_rs::TensorGeneric;
