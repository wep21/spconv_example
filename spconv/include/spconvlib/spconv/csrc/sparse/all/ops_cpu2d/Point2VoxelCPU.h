...
#include <spconvlib/spconv/csrc/sparse/all/ops_cpu2d/layout_ns/TensorGeneric.h>
#include <spconvlib/spconv/csrc/sparse/all/ops_cpu2d/p2v_c/Point2VoxelCommon.h>
namespace spconvlib {
namespace spconv {
namespace csrc {
namespace sparse {
...
struct Point2VoxelCPU {
  ...
  tv::array<float, 2> vsize;
  tv::array<float, 4> coors_range;
  tv::array<int, 2> grid_size;
  tv::array<int, 2> grid_stride;
  
  std::array<int, 2> get_grid_size();
  /**
   * @param vsize_xyz 
   * @param coors_range_xyz 
   */
  static std::tuple<std::array<float, 2>, std::array<int, 2>, std::array<int64_t, 2>, std::array<float, 4>> calc_meta_data(std::array<float, 2> vsize_xyz, std::array<float, 4> coors_range_xyz);
  /**
   * @param vsize_xyz 
   * @param coors_range_xyz 
   ...
   */
   Point2VoxelCPU(std::array<float, 2> vsize_xyz, std::array<float, 4> coors_range_xyz, int num_point_features, int max_num_voxels, int max_num_points_per_voxel);
